...
|83|:point_right:[删除排序链表中的重复元素](https://leetcode-cn.com/problems/remove-duplicates-from-sorted-list)|简单:bulb:|链表|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/83.remove-duplicates-from-sorted-list.java)|
...
|199|:point_right:[二叉树的右视图](https://leetcode-cn.com/problems/binary-tree-right-side-view)|中等:speech_balloon:|树、深度优先搜索、广度优先搜索、二叉树|:vertical_traffic_light:TODO|
...
|263|:point_right:[丑数](https://leetcode-cn.com/problems/ugly-number)|简单:bulb:|数学|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/263.ugly-number.java)|
...
|462|:point_right:[最少移动次数使数组元素相等 II](https://leetcode-cn.com/problems/minimum-moves-to-equal-array-elements-ii)|中等:speech_balloon:|数组、数学、排序|:vertical_traffic_light:TODO|
|463|:point_right:[岛屿的周长](https://leetcode-cn.com/problems/island-perimeter)|简单:bulb:|深度优先搜索、广度优先搜索、数组、矩阵|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/463.island-perimeter.java)|
|464|:point_right:[我能赢吗](https://leetcode-cn.com/problems/can-i-win)|中等:speech_balloon:|位运算、记忆化搜索、数学、动态规划、状态压缩、博弈|:vertical_traffic_light:TODO|
|465|最优账单平衡 :closed_lock_with_key:|困难:zzz:|数组、回溯|:vertical_traffic_light:TODO|
|466|:point_right:[统计重复个数](https://leetcode-cn.com/problems/count-the-repetitions)|困难:zzz:|字符串、动态规划|:vertical_traffic_light:TODO|
|467|:point_right:[环绕字符串中唯一的子字符串](https://leetcode-cn.com/problems/unique-substrings-in-wraparound-string)|中等:speech_balloon:|字符串、动态规划|:vertical_traffic_light:TODO|
...
|530|:point_right:[二叉搜索树的最小绝对差](https://leetcode-cn.com/problems/minimum-absolute-difference-in-bst)|简单:bulb:|树、深度优先搜索、广度优先搜索、二叉搜索树、二叉树|:vertical_traffic_light:TODO|
|531|孤独像素 I :closed_lock_with_key:|中等:speech_balloon:|数组、哈希表、矩阵|:vertical_traffic_light:TODO|
|532|:point_right:[数组中的 k-diff 数对](https://leetcode-cn.com/problems/k-diff-pairs-in-an-array)|中等:speech_balloon:|数组、哈希表、双指针、二分查找、排序|:vertical_traffic_light:TODO|
...
|568|最大休假天数 :closed_lock_with_key:|困难:zzz:|数组、动态规划、矩阵|:vertical_traffic_light:TODO|
...
|587|:point_right:[安装栅栏](https://leetcode-cn.com/problems/erect-the-fence)|困难:zzz:|几何、数组、数学|:vertical_traffic_light:TODO|
|588|设计内存文件系统 :closed_lock_with_key:|困难:zzz:|设计、字典树、哈希表、字符串|:vertical_traffic_light:TODO|
...
|604|迭代压缩字符串 :closed_lock_with_key:|简单:bulb:|设计、数组、哈希表、字符串、迭代器|:vertical_traffic_light:TODO|
|605|:point_right:[种花问题](https://leetcode-cn.com/problems/can-place-flowers)|简单:bulb:|贪心、数组|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/605.can-place-flowers.java)|
|606|:point_right:[根据二叉树创建字符串](https://leetcode-cn.com/problems/construct-string-from-binary-tree)|简单:bulb:|树、深度优先搜索、字符串、二叉树|:vertical_traffic_light:TODO|
|607|销售员 :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
...
|615|平均工资：部门与公司比较 :closed_lock_with_key:|困难:zzz:|数据库|:vertical_traffic_light:TODO|
|616|给字符串添加加粗标签 :closed_lock_with_key:|中等:speech_balloon:|字典树、数组、哈希表、字符串、字符串匹配|:vertical_traffic_light:TODO|
|617|:point_right:[合并二叉树](https://leetcode-cn.com/problems/merge-two-binary-trees)|简单:bulb:|树、深度优先搜索、广度优先搜索、二叉树|:truck:[Cpp](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/617.merge-two-binary-trees.cpp)|
|618|学生地理信息报告 :closed_lock_with_key:|困难:zzz:|数据库|:vertical_traffic_light:TODO|
|619|只出现一次的最大数字 :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|620|:point_right:[有趣的电影](https://leetcode-cn.com/problems/not-boring-movies)|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|621|:point_right:[任务调度器](https://leetcode-cn.com/problems/task-scheduler)|中等:speech_balloon:|贪心、数组、哈希表、计数、排序、堆（优先队列）|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/621.task-scheduler.java)|
|623|:point_right:[在二叉树中增加一行](https://leetcode-cn.com/problems/add-one-row-to-tree)|中等:speech_balloon:|树、深度优先搜索、广度优先搜索、二叉树|:vertical_traffic_light:TODO|
|624|数组列表中的最大距离 :closed_lock_with_key:|中等:speech_balloon:|贪心、数组|:vertical_traffic_light:TODO|
|625|最小因式分解 :closed_lock_with_key:|中等:speech_balloon:|贪心、数学|:vertical_traffic_light:TODO|
...
|634|寻找数组的错位排列 :closed_lock_with_key:|中等:speech_balloon:|数学、动态规划|:vertical_traffic_light:TODO|
...
|644|子数组最大平均数 II :closed_lock_with_key:|困难:zzz:|数组、二分查找|:vertical_traffic_light:TODO|
|645|:point_right:[错误的集合](https://leetcode-cn.com/problems/set-mismatch)|简单:bulb:|位运算、数组、哈希表、排序|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/645.set-mismatch.java)|
|646|:point_right:[最长数对链](https://leetcode-cn.com/problems/maximum-length-of-pair-chain)|中等:speech_balloon:|贪心、数组、动态规划、排序|:vertical_traffic_light:TODO|
...
|656|金币路径 :closed_lock_with_key:|困难:zzz:|数组、动态规划|:vertical_traffic_light:TODO|
|657|:point_right:[机器人能否返回原点](https://leetcode-cn.com/problems/robot-return-to-origin)|简单:bulb:|字符串、模拟|:vertical_traffic_light:TODO|
|658|:point_right:[找到 K 个最接近的元素](https://leetcode-cn.com/problems/find-k-closest-elements)|中等:speech_balloon:|数组、双指针、二分查找、排序、堆（优先队列）|:vertical_traffic_light:TODO|
|659|:point_right:[分割数组为连续子序列](https://leetcode-cn.com/problems/split-array-into-consecutive-subsequences)|中等:speech_balloon:|贪心、数组、哈希表、堆（优先队列）|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/659.split-array-into-consecutive-subsequences.java)|
|660|移除 9 :closed_lock_with_key:|困难:zzz:|数学|:vertical_traffic_light:TODO|
|661|:point_right:[图片平滑器](https://leetcode-cn.com/problems/image-smoother)|简单:bulb:|数组、矩阵|:vertical_traffic_light:TODO|
|662|:point_right:[二叉树最大宽度](https://leetcode-cn.com/problems/maximum-width-of-binary-tree)|中等:speech_balloon:|树、深度优先搜索、广度优先搜索、二叉树|:vertical_traffic_light:TODO|
|663|均匀树划分 :closed_lock_with_key:|中等:speech_balloon:|树、深度优先搜索、二叉树|:vertical_traffic_light:TODO|
|664|:point_right:[奇怪的打印机](https://leetcode-cn.com/problems/strange-printer)|困难:zzz:|字符串、动态规划|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/664.strange-printer.java)|
|665|:point_right:[非递减数列](https://leetcode-cn.com/problems/non-decreasing-array)|中等:speech_balloon:|数组|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/665.non-decreasing-array.java)|
|666|路径总和 IV :closed_lock_with_key:|中等:speech_balloon:|树、深度优先搜索、数组、二叉树|:vertical_traffic_light:TODO|
|667|:point_right:[优美的排列 II](https://leetcode-cn.com/problems/beautiful-arrangement-ii)|中等:speech_balloon:|数组、数学|:vertical_traffic_light:TODO|
...
|682|:point_right:[棒球比赛](https://leetcode-cn.com/problems/baseball-game)|简单:bulb:|栈、数组、模拟|:vertical_traffic_light:TODO|
...
|694|不同岛屿的数量 :closed_lock_with_key:|中等:speech_balloon:|深度优先搜索、广度优先搜索、并查集、哈希表、哈希函数|:vertical_traffic_light:TODO|
|695|:point_right:[岛屿的最大面积](https://leetcode-cn.com/problems/max-area-of-island)|中等:speech_balloon:|深度优先搜索、广度优先搜索、并查集、数组、矩阵|:vertical_traffic_light:TODO|
|696|:point_right:[计数二进制子串](https://leetcode-cn.com/problems/count-binary-substrings)|简单:bulb:|双指针、字符串|:vertical_traffic_light:TODO|
|697|:point_right:[数组的度](https://leetcode-cn.com/problems/degree-of-an-array)|简单:bulb:|数组、哈希表|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/697.degree-of-an-array.java)|
|698|:point_right:[划分为k个相等的子集](https://leetcode-cn.com/problems/partition-to-k-equal-sum-subsets)|中等:speech_balloon:|位运算、记忆化搜索、数组、动态规划、回溯、状态压缩|:vertical_traffic_light:TODO|
|699|:point_right:[掉落的方块](https://leetcode-cn.com/problems/falling-squares)|困难:zzz:|线段树、数组、有序集合|:vertical_traffic_light:TODO|
|711|不同岛屿的数量 II :closed_lock_with_key:|困难:zzz:|深度优先搜索、广度优先搜索、并查集、哈希表、哈希函数|:vertical_traffic_light:TODO|
|712|:point_right:[两个字符串的最小ASCII删除和](https://leetcode-cn.com/problems/minimum-ascii-delete-sum-for-two-strings)|中等:speech_balloon:|字符串、动态规划|:vertical_traffic_light:TODO|
|713|:point_right:[乘积小于K的子数组](https://leetcode-cn.com/problems/subarray-product-less-than-k)|中等:speech_balloon:|数组、滑动窗口|:vertical_traffic_light:TODO|
...
|721|:point_right:[账户合并](https://leetcode-cn.com/problems/accounts-merge)|中等:speech_balloon:|深度优先搜索、广度优先搜索、并查集、数组、字符串|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/721.accounts-merge.java)|
...
|730|:point_right:[统计不同回文子序列](https://leetcode-cn.com/problems/count-different-palindromic-subsequences)|困难:zzz:|字符串、动态规划|:vertical_traffic_light:TODO|
|731|:point_right:[我的日程安排表 II](https://leetcode-cn.com/problems/my-calendar-ii)|中等:speech_balloon:|设计、线段树、有序集合|:vertical_traffic_light:TODO|
|732|:point_right:[我的日程安排表 III](https://leetcode-cn.com/problems/my-calendar-iii)|困难:zzz:|设计、线段树、有序集合|:vertical_traffic_light:TODO|
|733|:point_right:[图像渲染](https://leetcode-cn.com/problems/flood-fill)|简单:bulb:|深度优先搜索、广度优先搜索、数组、矩阵|:vertical_traffic_light:TODO|
|734|句子相似性 :closed_lock_with_key:|简单:bulb:|数组、哈希表、字符串|:vertical_traffic_light:TODO|
|735|:point_right:[行星碰撞](https://leetcode-cn.com/problems/asteroid-collision)|中等:speech_balloon:|栈、数组|:vertical_traffic_light:TODO|
|736|:point_right:[Lisp 语法解析](https://leetcode-cn.com/problems/parse-lisp-expression)|困难:zzz:|栈、递归、哈希表、字符串|:vertical_traffic_light:TODO|
|737|句子相似性 II :closed_lock_with_key:|中等:speech_balloon:|深度优先搜索、广度优先搜索、并查集、数组、哈希表、字符串|:vertical_traffic_light:TODO|
|738|:point_right:[单调递增的数字](https://leetcode-cn.com/problems/monotone-increasing-digits)|中等:speech_balloon:|贪心、数学|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/738.monotone-increasing-digits.java)|
...
|753|:point_right:[打开转盘锁](https://leetcode-cn.com/problems/open-the-lock)|中等:speech_balloon:|广度优先搜索、数组、哈希表、字符串|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/753.open-the-lock.java)|
|754|:point_right:[破解保险箱](https://leetcode-cn.com/problems/cracking-the-safe)|困难:zzz:|深度优先搜索、图、欧拉回路|:vertical_traffic_light:TODO|
|755|:point_right:[到达终点数字](https://leetcode-cn.com/problems/reach-a-number)|中等:speech_balloon:|数学、二分查找|:vertical_traffic_light:TODO|
|756|倒水 :closed_lock_with_key:|中等:speech_balloon:|数组、模拟|:vertical_traffic_light:TODO|
|757|:point_right:[金字塔转换矩阵](https://leetcode-cn.com/problems/pyramid-transition-matrix)|中等:speech_balloon:|位运算、深度优先搜索、广度优先搜索|:vertical_traffic_light:TODO|
|758|将二叉搜索树转化为排序的双向链表 :closed_lock_with_key:|中等:speech_balloon:|栈、树、深度优先搜索、二叉搜索树、链表、二叉树、双向链表|:vertical_traffic_light:TODO|
|759|:point_right:[设置交集大小至少为2](https://leetcode-cn.com/problems/set-intersection-size-at-least-two)|困难:zzz:|贪心、数组、排序|:vertical_traffic_light:TODO|
|760|字符串中的加粗单词 :closed_lock_with_key:|中等:speech_balloon:|字典树、数组、哈希表、字符串、字符串匹配|:vertical_traffic_light:TODO|
|761|员工空闲时间 :closed_lock_with_key:|困难:zzz:|数组、排序、堆（优先队列）|:vertical_traffic_light:TODO|
|762|找出变位映射 :closed_lock_with_key:|简单:bulb:|数组、哈希表|:vertical_traffic_light:TODO|
...
|770|:point_right:[情侣牵手](https://leetcode-cn.com/problems/couples-holding-hands)|困难:zzz:|贪心、深度优先搜索、广度优先搜索、并查集、图|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/770.couples-holding-hands.java)|
...
|787|:point_right:[滑动谜题](https://leetcode-cn.com/problems/sliding-puzzle)|困难:zzz:|广度优先搜索、数组、矩阵|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/787.sliding-puzzle.java)|
|788|最小化去加油站的最大距离 :closed_lock_with_key:|困难:zzz:|数组、二分查找|:vertical_traffic_light:TODO|
...
|833|:point_right:[公交路线](https://leetcode-cn.com/problems/bus-routes)|困难:zzz:|广度优先搜索、数组、哈希表|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/833.bus-routes.java)|
...
|842|:point_right:[翻转卡片游戏](https://leetcode-cn.com/problems/card-flipping-game)|中等:speech_balloon:|数组、哈希表|:vertical_traffic_light:TODO|
...
|856|:point_right:[连续整数求和](https://leetcode-cn.com/problems/consecutive-numbers-sum)|困难:zzz:|数学、枚举|:vertical_traffic_light:TODO|
|857|:point_right:[较大分组的位置](https://leetcode-cn.com/problems/positions-of-large-groups)|简单:bulb:|字符串|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/857.positions-of-large-groups.java)|
...
|872|:point_right:[将数组拆分成斐波那契序列](https://leetcode-cn.com/problems/split-array-into-fibonacci-sequence)|中等:speech_balloon:|字符串、回溯|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/872.split-array-into-fibonacci-sequence.java)|
...
|933|:point_right:[递增顺序搜索树](https://leetcode-cn.com/problems/increasing-order-search-tree)|简单:bulb:|栈、树、深度优先搜索、二叉搜索树、二叉树|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/933.increasing-order-search-tree.java)|
|934|:point_right:[子数组按位或操作](https://leetcode-cn.com/problems/bitwise-ors-of-subarrays)|中等:speech_balloon:|位运算、数组、动态规划|:vertical_traffic_light:TODO|
|935|:point_right:[有序队列](https://leetcode-cn.com/problems/orderly-queue)|困难:zzz:|数学、字符串、排序|:vertical_traffic_light:TODO|
|936|:point_right:[RLE 迭代器](https://leetcode-cn.com/problems/rle-iterator)|中等:speech_balloon:|设计、数组、计数、迭代器|:vertical_traffic_light:TODO|
|937|:point_right:[股票价格跨度](https://leetcode-cn.com/problems/online-stock-span)|中等:speech_balloon:|栈、设计、数据流、单调栈|:vertical_traffic_light:TODO|
|938|:point_right:[最大为 N 的数字组合](https://leetcode-cn.com/problems/numbers-at-most-n-given-digit-set)|困难:zzz:|数组、数学、二分查找、动态规划|:vertical_traffic_light:TODO|
|939|:point_right:[DI 序列的有效排列](https://leetcode-cn.com/problems/valid-permutations-for-di-sequence)|困难:zzz:|动态规划|:vertical_traffic_light:TODO|
|940|:point_right:[水果成篮](https://leetcode-cn.com/problems/fruit-into-baskets)|中等:speech_balloon:|数组、哈希表、滑动窗口|:vertical_traffic_light:TODO|
|941|:point_right:[按奇偶排序数组](https://leetcode-cn.com/problems/sort-array-by-parity)|简单:bulb:|数组、双指针、排序|:truck:[Cpp](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/941.sort-array-by-parity.cpp)|
|942|:point_right:[超级回文数](https://leetcode-cn.com/problems/super-palindromes)|困难:zzz:|数学、枚举|:vertical_traffic_light:TODO|
|943|:point_right:[子数组的最小值之和](https://leetcode-cn.com/problems/sum-of-subarray-minimums)|中等:speech_balloon:|栈、数组、动态规划、单调栈|:vertical_traffic_light:TODO|
...
|957|:point_right:[使括号有效的最少添加](https://leetcode-cn.com/problems/minimum-add-to-make-parentheses-valid)|中等:speech_balloon:|栈、贪心、字符串|:vertical_traffic_light:TODO|
|958|:point_right:[按奇偶排序数组 II](https://leetcode-cn.com/problems/sort-array-by-parity-ii)|简单:bulb:|数组、双指针、排序|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/958.sort-array-by-parity-ii.java)|
|959|:point_right:[三数之和的多种可能](https://leetcode-cn.com/problems/3sum-with-multiplicity)|中等:speech_balloon:|数组、哈希表、双指针、计数、排序|:vertical_traffic_light:TODO|
|960|:point_right:[尽量减少恶意软件的传播](https://leetcode-cn.com/problems/minimize-malware-spread)|困难:zzz:|深度优先搜索、广度优先搜索、并查集、数组、矩阵|:vertical_traffic_light:TODO|
|961|:point_right:[长按键入](https://leetcode-cn.com/problems/long-pressed-name)|简单:bulb:|双指针、字符串|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/961.long-pressed-name.java)|
|962|:point_right:[将字符串翻转到单调递增](https://leetcode-cn.com/problems/flip-string-to-monotone-increasing)|中等:speech_balloon:|字符串、动态规划|:vertical_traffic_light:TODO|
|963|:point_right:[三等分](https://leetcode-cn.com/problems/three-equal-parts)|困难:zzz:|数组、数学|:vertical_traffic_light:TODO|
|964|:point_right:[尽量减少恶意软件的传播 II](https://leetcode-cn.com/problems/minimize-malware-spread-ii)|困难:zzz:|深度优先搜索、广度优先搜索、并查集、数组、矩阵|:vertical_traffic_light:TODO|
|965|:point_right:[独特的电子邮件地址](https://leetcode-cn.com/problems/unique-email-addresses)|简单:bulb:|数组、哈希表、字符串|:vertical_traffic_light:TODO|
|966|:point_right:[和相同的二元子数组](https://leetcode-cn.com/problems/binary-subarrays-with-sum)|中等:speech_balloon:|数组、哈希表、前缀和、滑动窗口|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/966.binary-subarrays-with-sum.java)|
|967|:point_right:[下降路径最小和](https://leetcode-cn.com/problems/minimum-falling-path-sum)|中等:speech_balloon:|数组、动态规划、矩阵|:vertical_traffic_light:TODO|
|968|:point_right:[漂亮数组](https://leetcode-cn.com/problems/beautiful-array)|中等:speech_balloon:|数组、数学、分治|:vertical_traffic_light:TODO|
|969|:point_right:[最近的请求次数](https://leetcode-cn.com/problems/number-of-recent-calls)|简单:bulb:|设计、队列、数据流|:vertical_traffic_light:TODO|
|971|:point_right:[最短的桥](https://leetcode-cn.com/problems/shortest-bridge)|中等:speech_balloon:|深度优先搜索、广度优先搜索、数组、矩阵|:vertical_traffic_light:TODO|
|972|:point_right:[骑士拨号器](https://leetcode-cn.com/problems/knight-dialer)|中等:speech_balloon:|动态规划|:vertical_traffic_light:TODO|
|973|:point_right:[戳印序列](https://leetcode-cn.com/problems/stamping-the-sequence)|困难:zzz:|栈、贪心、队列、字符串|:vertical_traffic_light:TODO|
|974|:point_right:[重新排列日志文件](https://leetcode-cn.com/problems/reorder-data-in-log-files)|简单:bulb:|数组、字符串、排序|:vertical_traffic_light:TODO|
|975|:point_right:[二叉搜索树的范围和](https://leetcode-cn.com/problems/range-sum-of-bst)|简单:bulb:|树、深度优先搜索、二叉搜索树、二叉树|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/975.range-sum-of-bst.java)|
|976|:point_right:[最小面积矩形](https://leetcode-cn.com/problems/minimum-area-rectangle)|中等:speech_balloon:|几何、数组、哈希表、数学、排序|:vertical_traffic_light:TODO|
|977|:point_right:[不同的子序列 II](https://leetcode-cn.com/problems/distinct-subsequences-ii)|困难:zzz:|字符串、动态规划|:vertical_traffic_light:TODO|
|978|:point_right:[有效的山脉数组](https://leetcode-cn.com/problems/valid-mountain-array)|简单:bulb:|数组|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/978.valid-mountain-array.java)|
|979|:point_right:[增减字符串匹配](https://leetcode-cn.com/problems/di-string-match)|简单:bulb:|贪心、数组、数学、双指针、字符串|:vertical_traffic_light:TODO|
|980|:point_right:[最短超级串](https://leetcode-cn.com/problems/find-the-shortest-superstring)|困难:zzz:|位运算、数组、字符串、动态规划、状态压缩|:vertical_traffic_light:TODO|
|981|:point_right:[删列造序](https://leetcode-cn.com/problems/delete-columns-to-make-sorted)|简单:bulb:|数组、字符串|:vertical_traffic_light:TODO|
|982|:point_right:[使数组唯一的最小增量](https://leetcode-cn.com/problems/minimum-increment-to-make-array-unique)|中等:speech_balloon:|贪心、数组、计数、排序|:vertical_traffic_light:TODO|
|983|:point_right:[验证栈序列](https://leetcode-cn.com/problems/validate-stack-sequences)|中等:speech_balloon:|栈、数组、模拟|:vertical_traffic_light:TODO|
|984|:point_right:[移除最多的同行或同列石头](https://leetcode-cn.com/problems/most-stones-removed-with-same-row-or-column)|中等:speech_balloon:|深度优先搜索、并查集、图|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/984.most-stones-removed-with-same-row-or-column.java)|
|985|:point_right:[令牌放置](https://leetcode-cn.com/problems/bag-of-tokens)|中等:speech_balloon:|贪心、数组、双指针、排序|:vertical_traffic_light:TODO|
|986|:point_right:[给定数字能组成的最大时间](https://leetcode-cn.com/problems/largest-time-for-given-digits)|中等:speech_balloon:|字符串、枚举|:vertical_traffic_light:TODO|
|987|:point_right:[按递增顺序显示卡牌](https://leetcode-cn.com/problems/reveal-cards-in-increasing-order)|中等:speech_balloon:|队列、数组、排序、模拟|:vertical_traffic_light:TODO|
|988|:point_right:[翻转等价二叉树](https://leetcode-cn.com/problems/flip-equivalent-binary-trees)|中等:speech_balloon:|树、深度优先搜索、二叉树|:vertical_traffic_light:TODO|
|989|:point_right:[按公因数计算最大组件大小](https://leetcode-cn.com/problems/largest-component-size-by-common-factor)|困难:zzz:|并查集、数组、数学|:vertical_traffic_light:TODO|
|990|:point_right:[验证外星语词典](https://leetcode-cn.com/problems/verifying-an-alien-dictionary)|简单:bulb:|数组、哈希表、字符串|:vertical_traffic_light:TODO|
|991|:point_right:[二倍数对数组](https://leetcode-cn.com/problems/array-of-doubled-pairs)|中等:speech_balloon:|贪心、数组、哈希表、排序|:vertical_traffic_light:TODO|
|992|:point_right:[删列造序 II](https://leetcode-cn.com/problems/delete-columns-to-make-sorted-ii)|中等:speech_balloon:|贪心、数组、字符串|:vertical_traffic_light:TODO|
|993|:point_right:[最高的广告牌](https://leetcode-cn.com/problems/tallest-billboard)|困难:zzz:|数组、动态规划|:vertical_traffic_light:TODO|
|994|:point_right:[N 天后的牢房](https://leetcode-cn.com/problems/prison-cells-after-n-days)|中等:speech_balloon:|位运算、数组、哈希表、数学|:vertical_traffic_light:TODO|
...
|1005|:point_right:[单值二叉树](https://leetcode-cn.com/problems/univalued-binary-tree)|简单:bulb:|树、深度优先搜索、广度优先搜索、二叉树|:vertical_traffic_light:TODO|
...
|1013|:point_right:[斐波那契数](https://leetcode-cn.com/problems/fibonacci-number)|简单:bulb:|递归、记忆化搜索、数学、动态规划|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/1013.fibonacci-number.java)|
|1014|:point_right:[最接近原点的 K 个点](https://leetcode-cn.com/problems/k-closest-points-to-origin)|中等:speech_balloon:|几何、数组、数学、分治、快速选择、排序、堆（优先队列）|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/1014.k-closest-points-to-origin.java)|
|1016|:point_right:[和可被 K 整除的子数组](https://leetcode-cn.com/problems/subarray-sums-divisible-by-k)|中等:speech_balloon:|数组、哈希表、前缀和|:vertical_traffic_light:TODO|
|1017|:point_right:[奇偶跳](https://leetcode-cn.com/problems/odd-even-jump)|困难:zzz:|栈、数组、动态规划、有序集合、单调栈|:vertical_traffic_light:TODO|
|1018|:point_right:[三角形的最大周长](https://leetcode-cn.com/problems/largest-perimeter-triangle)|简单:bulb:|贪心、数组、数学、排序|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/1018.largest-perimeter-triangle.java)|
|1019|:point_right:[有序数组的平方](https://leetcode-cn.com/problems/squares-of-a-sorted-array)|简单:bulb:|数组、双指针、排序|:vertical_traffic_light:TODO|
|1020|:point_right:[最长湍流子数组](https://leetcode-cn.com/problems/longest-turbulent-subarray)|中等:speech_balloon:|数组、动态规划、滑动窗口|:truck:[Cpp](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/1020.longest-turbulent-subarray.cpp)|
|1021|:point_right:[在二叉树中分配硬币](https://leetcode-cn.com/problems/distribute-coins-in-binary-tree)|中等:speech_balloon:|树、深度优先搜索、二叉树|:vertical_traffic_light:TODO|
|1022|:point_right:[不同路径 III](https://leetcode-cn.com/problems/unique-paths-iii)|困难:zzz:|位运算、数组、回溯、矩阵|:vertical_traffic_light:TODO|
|1023|:point_right:[基于时间的键值存储](https://leetcode-cn.com/problems/time-based-key-value-store)|中等:speech_balloon:|设计、哈希表、字符串、二分查找|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/1023.time-based-key-value-store.java)|
...
|1033|:point_right:[坏了的计算器](https://leetcode-cn.com/problems/broken-calculator)|中等:speech_balloon:|贪心、数学|:vertical_traffic_light:TODO|
|1034|:point_right:[K 个不同整数的子数组](https://leetcode-cn.com/problems/subarrays-with-k-different-integers)|困难:zzz:|数组、哈希表、计数、滑动窗口|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/1034.subarrays-with-k-different-integers.java)|
|1035|:point_right:[二叉树的堂兄弟节点](https://leetcode-cn.com/problems/cousins-in-binary-tree)|简单:bulb:|树、深度优先搜索、广度优先搜索、二叉树|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/1035.cousins-in-binary-tree.java)|
...
|1051|形成字符串的最短路径 :closed_lock_with_key:|中等:speech_balloon:|贪心、字符串、动态规划|:vertical_traffic_light:TODO|
|1052|校园自行车分配 :closed_lock_with_key:|中等:speech_balloon:|贪心、数组、排序|:vertical_traffic_light:TODO|
|1053|最小化舍入误差以满足目标 :closed_lock_with_key:|中等:speech_balloon:|贪心、数组、数学、字符串|:vertical_traffic_light:TODO|
|1054|:point_right:[十进制整数的反码](https://leetcode-cn.com/problems/complement-of-base-10-integer)|简单:bulb:|位运算|:vertical_traffic_light:TODO|
|1055|:point_right:[总持续时间可被 60 整除的歌曲](https://leetcode-cn.com/problems/pairs-of-songs-with-total-durations-divisible-by-60)|中等:speech_balloon:|数组、哈希表、计数|:vertical_traffic_light:TODO|
|1056|:point_right:[在 D 天内送达包裹的能力](https://leetcode-cn.com/problems/capacity-to-ship-packages-within-d-days)|中等:speech_balloon:|贪心、数组、二分查找|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/1056.capacity-to-ship-packages-within-d-days.java)|
|1057|:point_right:[至少有 1 位重复的数字](https://leetcode-cn.com/problems/numbers-with-repeated-digits)|困难:zzz:|数学、动态规划|:vertical_traffic_light:TODO|
|1058|按字典序排列最小的等效字符串 :closed_lock_with_key:|中等:speech_balloon:|并查集、字符串|:vertical_traffic_light:TODO|
|1059|有序数组中的缺失元素 :closed_lock_with_key:|中等:speech_balloon:|数组、二分查找|:vertical_traffic_light:TODO|
|1060|最长重复子串 :closed_lock_with_key:|中等:speech_balloon:|字符串、二分查找、动态规划、后缀数组、哈希函数、滚动哈希|:vertical_traffic_light:TODO|
|1061|有效子数组的数目 :closed_lock_with_key:|困难:zzz:|栈、数组、单调栈|:vertical_traffic_light:TODO|
|1062|:point_right:[将数组分成和相等的三个部分](https://leetcode-cn.com/problems/partition-array-into-three-parts-with-equal-sum)|简单:bulb:|贪心、数组|:vertical_traffic_light:TODO|
|1063|:point_right:[最佳观光组合](https://leetcode-cn.com/problems/best-sightseeing-pair)|中等:speech_balloon:|数组、动态规划|:vertical_traffic_light:TODO|
|1064|:point_right:[可被 K 整除的最小整数](https://leetcode-cn.com/problems/smallest-integer-divisible-by-k)|中等:speech_balloon:|哈希表、数学|:vertical_traffic_light:TODO|
|1065|:point_right:[子串能表示从 1 到 N 数字的二进制串](https://leetcode-cn.com/problems/binary-string-with-substrings-representing-1-to-n)|中等:speech_balloon:|字符串|:vertical_traffic_light:TODO|
|1066|不动点 :closed_lock_with_key:|简单:bulb:|数组、二分查找|:vertical_traffic_light:TODO|
|1067|校园自行车分配 II :closed_lock_with_key:|中等:speech_balloon:|位运算、数组、动态规划、回溯、状态压缩|:vertical_traffic_light:TODO|
|1068|范围内的数字计数 :closed_lock_with_key:|困难:zzz:|数学、动态规划|:vertical_traffic_light:TODO|
|1069|易混淆数 :closed_lock_with_key:|简单:bulb:|数学|:vertical_traffic_light:TODO|
...
|1077|易混淆数 II :closed_lock_with_key:|困难:zzz:|数学、回溯|:vertical_traffic_light:TODO|
|1078|:point_right:[删除最外层的括号](https://leetcode-cn.com/problems/remove-outermost-parentheses)|简单:bulb:|栈、字符串|:truck:[Cpp](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/1078.remove-outermost-parentheses.cpp)|
|1079|:point_right:[从根到叶的二进制数之和](https://leetcode-cn.com/problems/sum-of-root-to-leaf-binary-numbers)|简单:bulb:|树、深度优先搜索、二叉树|:vertical_traffic_light:TODO|
|1080|:point_right:[驼峰式匹配](https://leetcode-cn.com/problems/camelcase-matching)|中等:speech_balloon:|字典树、双指针、字符串、字符串匹配|:vertical_traffic_light:TODO|
|1081|:point_right:[视频拼接](https://leetcode-cn.com/problems/video-stitching)|中等:speech_balloon:|贪心、数组、动态规划|:vertical_traffic_light:TODO|
|1082|最小元素各数位之和 :closed_lock_with_key:|简单:bulb:|数组、数学|:vertical_traffic_light:TODO|
|1083|小于 K 的两数之和 :closed_lock_with_key:|简单:bulb:|数组、双指针、二分查找、排序|:vertical_traffic_light:TODO|
|1084|长度为 K 的无重复字符子串 :closed_lock_with_key:|中等:speech_balloon:|哈希表、字符串、滑动窗口|:vertical_traffic_light:TODO|
|1085|彼此熟识的最早时间 :closed_lock_with_key:|中等:speech_balloon:|并查集、数组|:vertical_traffic_light:TODO|
|1086|:point_right:[除数博弈](https://leetcode-cn.com/problems/divisor-game)|简单:bulb:|脑筋急转弯、数学、动态规划、博弈|:vertical_traffic_light:TODO|
|1087|:point_right:[最长等差数列](https://leetcode-cn.com/problems/longest-arithmetic-subsequence)|中等:speech_balloon:|数组、哈希表、二分查找、动态规划|:vertical_traffic_light:TODO|
|1088|一月有多少天 :closed_lock_with_key:|简单:bulb:|数学|:vertical_traffic_light:TODO|
|1089|删去字符串中的元音 :closed_lock_with_key:|简单:bulb:|字符串|:vertical_traffic_light:TODO|
|1090|阿姆斯特朗数 :closed_lock_with_key:|简单:bulb:|数学|:vertical_traffic_light:TODO|
|1091|子树的最大平均值 :closed_lock_with_key:|中等:speech_balloon:|树、深度优先搜索、二叉树|:vertical_traffic_light:TODO|
|1092|:point_right:[节点与其祖先之间的最大差值](https://leetcode-cn.com/problems/maximum-difference-between-node-and-ancestor)|中等:speech_balloon:|树、深度优先搜索、二叉树|:vertical_traffic_light:TODO|
|1093|:point_right:[从先序遍历还原二叉树](https://leetcode-cn.com/problems/recover-a-tree-from-preorder-traversal)|困难:zzz:|树、深度优先搜索、字符串、二叉树|:vertical_traffic_light:TODO|
|1094|:point_right:[距离顺序排列矩阵单元格](https://leetcode-cn.com/problems/matrix-cells-in-distance-order)|简单:bulb:|几何、数组、数学、矩阵、排序|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/1094.matrix-cells-in-distance-order.java)|
|1095|:point_right:[两地调度](https://leetcode-cn.com/problems/two-city-scheduling)|中等:speech_balloon:|贪心、数组、排序|:vertical_traffic_light:TODO|
|1096|:point_right:[两个非重叠子数组的最大和](https://leetcode-cn.com/problems/maximum-sum-of-two-non-overlapping-subarrays)|中等:speech_balloon:|数组、动态规划、滑动窗口|:vertical_traffic_light:TODO|
|1097|:point_right:[字符流](https://leetcode-cn.com/problems/stream-of-characters)|困难:zzz:|设计、字典树、数组、字符串、数据流|:vertical_traffic_light:TODO|
|1098|最大唯一数 :closed_lock_with_key:|简单:bulb:|数组、哈希表、排序|:vertical_traffic_light:TODO|
|1099|得分最高的路径 :closed_lock_with_key:|中等:speech_balloon:|深度优先搜索、广度优先搜索、并查集、数组、矩阵、堆（优先队列）|:vertical_traffic_light:TODO|
...
|1126|连接棒材的最低费用 :closed_lock_with_key:|中等:speech_balloon:|贪心、数组、堆（优先队列）|:vertical_traffic_light:TODO|
|1127|:point_right:[最后一块石头的重量](https://leetcode-cn.com/problems/last-stone-weight)|简单:bulb:|数组、堆（优先队列）|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/1127.last-stone-weight.java)|
|1128|:point_right:[删除字符串中的所有相邻重复项](https://leetcode-cn.com/problems/remove-all-adjacent-duplicates-in-string)|简单:bulb:|栈、字符串|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/1128.remove-all-adjacent-duplicates-in-string.java)|
|1129|:point_right:[最长字符串链](https://leetcode-cn.com/problems/longest-string-chain)|中等:speech_balloon:|数组、哈希表、双指针、字符串、动态规划|:vertical_traffic_light:TODO|
|1130|:point_right:[最后一块石头的重量 II](https://leetcode-cn.com/problems/last-stone-weight-ii)|中等:speech_balloon:|数组、动态规划|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/1130.last-stone-weight-ii.java)|
|1131|统计只含单一字母的子串 :closed_lock_with_key:|简单:bulb:|数学、字符串|:vertical_traffic_light:TODO|
|1132|前后拼接 :closed_lock_with_key:|中等:speech_balloon:|数组、哈希表、字符串、排序|:vertical_traffic_light:TODO|
|1133|:point_right:[按字典序排在最后的子串](https://leetcode-cn.com/problems/last-substring-in-lexicographical-order)|困难:zzz:|双指针、字符串|:vertical_traffic_light:TODO|
|1134|与目标颜色间的最短距离 :closed_lock_with_key:|中等:speech_balloon:|数组、二分查找、动态规划|:vertical_traffic_light:TODO|
|1135|买下所有产品的客户 :closed_lock_with_key:|中等:speech_balloon:|数据库|:vertical_traffic_light:TODO|
|1136|合作过至少三次的演员和导演 :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|1137|:point_right:[高度检查器](https://leetcode-cn.com/problems/height-checker)|简单:bulb:|数组、计数排序、排序|:vertical_traffic_light:TODO|
|1138|:point_right:[爱生气的书店老板](https://leetcode-cn.com/problems/grumpy-bookstore-owner)|中等:speech_balloon:|数组、滑动窗口|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/1138.grumpy-bookstore-owner.java)|
|1139|:point_right:[交换一次的先前排列](https://leetcode-cn.com/problems/previous-permutation-with-one-swap)|中等:speech_balloon:|贪心、数组|:vertical_traffic_light:TODO|
|1140|:point_right:[距离相等的条形码](https://leetcode-cn.com/problems/distant-barcodes)|中等:speech_balloon:|贪心、数组、哈希表、计数、排序、堆（优先队列）|:vertical_traffic_light:TODO|
|1141|最多可以买到的苹果数量 :closed_lock_with_key:|简单:bulb:|贪心、数组、排序|:vertical_traffic_light:TODO|
|1142|进击的骑士 :closed_lock_with_key:|中等:speech_balloon:|广度优先搜索|:vertical_traffic_light:TODO|
|1143|找出所有行中最小公共元素 :closed_lock_with_key:|中等:speech_balloon:|数组、哈希表、二分查找、计数、矩阵|:vertical_traffic_light:TODO|
|1144|水资源分配优化 :closed_lock_with_key:|困难:zzz:|并查集、图、最小生成树|:vertical_traffic_light:TODO|
|1145|:point_right:[元素和为目标值的子矩阵数量](https://leetcode-cn.com/problems/number-of-submatrices-that-sum-to-target)|困难:zzz:|数组、哈希表、矩阵、前缀和|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/1145.number-of-submatrices-that-sum-to-target.java)|
|1146|:point_right:[字符串的最大公因子](https://leetcode-cn.com/problems/greatest-common-divisor-of-strings)|简单:bulb:|数学、字符串|:vertical_traffic_light:TODO|
|1147|:point_right:[按列翻转得到最大值等行数](https://leetcode-cn.com/problems/flip-columns-for-maximum-number-of-equal-rows)|中等:speech_balloon:|数组、哈希表、矩阵|:vertical_traffic_light:TODO|
|1148|:point_right:[负二进制数相加](https://leetcode-cn.com/problems/adding-two-negabinary-numbers)|中等:speech_balloon:|数组、数学|:vertical_traffic_light:TODO|
|1149|三个有序数组的交集 :closed_lock_with_key:|简单:bulb:|数组、哈希表、二分查找、计数|:vertical_traffic_light:TODO|
|1150|查找两棵二叉搜索树之和 :closed_lock_with_key:|中等:speech_balloon:|栈、树、深度优先搜索、二叉搜索树、双指针、二分查找、二叉树|:vertical_traffic_light:TODO|
|1151|步进数 :closed_lock_with_key:|中等:speech_balloon:|广度优先搜索、回溯|:vertical_traffic_light:TODO|
|1152|矩阵中 1 的最大数量 :closed_lock_with_key:|困难:zzz:|贪心、堆（优先队列）|:vertical_traffic_light:TODO|
...
|1163|项目员工 III :closed_lock_with_key:|中等:speech_balloon:|数据库|:vertical_traffic_light:TODO|
|1164|等差数列中缺失的数字 :closed_lock_with_key:|简单:bulb:|数组、数学|:vertical_traffic_light:TODO|
|1165|安排会议日程 :closed_lock_with_key:|中等:speech_balloon:|数组、双指针、排序|:vertical_traffic_light:TODO|
|1166|抛掷硬币 :closed_lock_with_key:|中等:speech_balloon:|数学、动态规划、概率与统计|:vertical_traffic_light:TODO|
|1167|建造街区的最短时间 :closed_lock_with_key:|困难:zzz:|贪心、数学、堆（优先队列）|:vertical_traffic_light:TODO|
|1168|:point_right:[复写零](https://leetcode-cn.com/problems/duplicate-zeros)|简单:bulb:|数组、双指针|:vertical_traffic_light:TODO|
|1169|:point_right:[受标签影响的最大值](https://leetcode-cn.com/problems/largest-values-from-labels)|中等:speech_balloon:|贪心、数组、哈希表、计数、排序|:vertical_traffic_light:TODO|
|1170|:point_right:[最短公共超序列](https://leetcode-cn.com/problems/shortest-common-supersequence)|困难:zzz:|字符串、动态规划|:vertical_traffic_light:TODO|
|1171|:point_right:[二进制矩阵中的最短路径](https://leetcode-cn.com/problems/shortest-path-in-binary-matrix)|中等:speech_balloon:|广度优先搜索、数组、矩阵|:vertical_traffic_light:TODO|
|1172|销售分析 I  :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|1173|销售分析 II :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|1174|销售分析III :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|1175|数组变换 :closed_lock_with_key:|简单:bulb:|数组、模拟|:vertical_traffic_light:TODO|
|1176|力扣排行榜 :closed_lock_with_key:|中等:speech_balloon:|设计、哈希表、排序|:vertical_traffic_light:TODO|
|1177|树的直径 :closed_lock_with_key:|中等:speech_balloon:|树、深度优先搜索、广度优先搜索|:vertical_traffic_light:TODO|
|1178|验证回文字符串 III :closed_lock_with_key:|困难:zzz:|字符串、动态规划|:vertical_traffic_light:TODO|
|1179|游戏玩法分析 I :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|1180|游戏玩法分析 II :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|1181|游戏玩法分析 III :closed_lock_with_key:|中等:speech_balloon:|数据库|:vertical_traffic_light:TODO|
|1182|游戏玩法分析 IV :closed_lock_with_key:|中等:speech_balloon:|数据库|:vertical_traffic_light:TODO|
|1183|:point_right:[大样本统计](https://leetcode-cn.com/problems/statistics-from-a-large-sample)|中等:speech_balloon:|数学、双指针、概率与统计|:vertical_traffic_light:TODO|
...
|1198|小众书籍 :closed_lock_with_key:|中等:speech_balloon:|数据库|:vertical_traffic_light:TODO|
|1199|十六进制魔术数字 :closed_lock_with_key:|简单:bulb:|数学、字符串|:vertical_traffic_light:TODO|
|1200|删除区间 :closed_lock_with_key:|中等:speech_balloon:|数组|:vertical_traffic_light:TODO|
|1201|删除树节点 :closed_lock_with_key:|中等:speech_balloon:|树、深度优先搜索、广度优先搜索|:vertical_traffic_light:TODO|
...
|1210|:point_right:[删除某些元素后的数组均值](https://leetcode-cn.com/problems/mean-of-array-after-removing-some-elements)|简单:bulb:|数组、排序|:vertical_traffic_light:TODO|
|1211|:point_right:[字母组合迭代器](https://leetcode-cn.com/problems/iterator-for-combination)|中等:speech_balloon:|设计、字符串、回溯、迭代器|:vertical_traffic_light:TODO|
|1212|:point_right:[顺次数](https://leetcode-cn.com/problems/sequential-digits)|中等:speech_balloon:|枚举|:vertical_traffic_light:TODO|
|1213|不相交的握手 :closed_lock_with_key:|困难:zzz:|数学、动态规划|:vertical_traffic_light:TODO|
...
|1221|:point_right:[有序数组中出现次数超过25%的元素](https://leetcode-cn.com/problems/element-appearing-more-than-25-in-sorted-array)|简单:bulb:|数组|:vertical_traffic_light:TODO|
|1222|:point_right:[删除被覆盖区间](https://leetcode-cn.com/problems/remove-covered-intervals)|中等:speech_balloon:|数组、排序|:vertical_traffic_light:TODO|
|1223|:point_right:[带阈值的图连通性](https://leetcode-cn.com/problems/graph-connectivity-with-threshold)|困难:zzz:|并查集、数组、数学|:vertical_traffic_light:TODO|
...
|1231|:point_right:[将每个元素替换为右侧最大元素](https://leetcode-cn.com/problems/replace-elements-with-greatest-element-on-right-side)|简单:bulb:|数组|:vertical_traffic_light:TODO|
...
|1240|:point_right:[石子游戏 II](https://leetcode-cn.com/problems/stone-game-ii)|中等:speech_balloon:|数组、数学、动态规划、博弈|:vertical_traffic_light:TODO|
|1241|:point_right:[解压缩编码列表](https://leetcode-cn.com/problems/decompress-run-length-encoded-list)|简单:bulb:|数组|:vertical_traffic_light:TODO|
|1242|:point_right:[矩阵区域和](https://leetcode-cn.com/problems/matrix-block-sum)|中等:speech_balloon:|数组、矩阵、前缀和|:vertical_traffic_light:TODO|
|1243|:point_right:[祖父节点值为偶数的节点和](https://leetcode-cn.com/problems/sum-of-nodes-with-even-valued-grandparent)|中等:speech_balloon:|树、深度优先搜索、广度优先搜索、二叉树|:vertical_traffic_light:TODO|
|1244|:point_right:[不同的循环子字符串](https://leetcode-cn.com/problems/distinct-echo-substrings)|困难:zzz:|字典树、字符串、动态规划、滑动窗口、哈希函数、滚动哈希|:vertical_traffic_light:TODO|
|1245|查询近30天活跃用户数 :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|1246|过去30天的用户活动 II :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
...
|1254|:point_right:[层数最深叶子节点的和](https://leetcode-cn.com/problems/deepest-leaves-sum)|中等:speech_balloon:|树、深度优先搜索、广度优先搜索、二叉树|:vertical_traffic_light:TODO|
|1255|:point_right:[翻转子数组得到最大的数组值](https://leetcode-cn.com/problems/reverse-subarray-to-maximize-array-value)|困难:zzz:|贪心、数组、数学|:vertical_traffic_light:TODO|
|1256|:point_right:[数组序号转换](https://leetcode-cn.com/problems/rank-transform-of-an-array)|简单:bulb:|数组、哈希表、排序|:vertical_traffic_light:TODO|
...
|1270|:point_right:[餐盘栈](https://leetcode-cn.com/problems/dinner-plate-stacks)|困难:zzz:|栈、设计、哈希表、堆（优先队列）|:vertical_traffic_light:TODO|
|1271|网络爬虫 :closed_lock_with_key:|中等:speech_balloon:|深度优先搜索、广度优先搜索、字符串、交互|:vertical_traffic_light:TODO|
|1272|:point_right:[查询无效交易](https://leetcode-cn.com/problems/invalid-transactions)|中等:speech_balloon:|数组、哈希表、字符串、排序|:vertical_traffic_light:TODO|
|1273|:point_right:[比较字符串最小字母出现频次](https://leetcode-cn.com/problems/compare-strings-by-frequency-of-the-smallest-character)|中等:speech_balloon:|数组、哈希表、字符串、二分查找、排序|:vertical_traffic_light:TODO|
|1274|:point_right:[日期之间隔几天](https://leetcode-cn.com/problems/number-of-days-between-two-dates)|简单:bulb:|数学、字符串|:vertical_traffic_light:TODO|
|1275|:point_right:[验证二叉树](https://leetcode-cn.com/problems/validate-binary-tree-nodes)|中等:speech_balloon:|树、深度优先搜索、广度优先搜索、并查集、图、二叉树|:vertical_traffic_light:TODO|
|1276|:point_right:[最接近的因数](https://leetcode-cn.com/problems/closest-divisors)|中等:speech_balloon:|数学|:vertical_traffic_light:TODO|
|1277|:point_right:[形成三的最大倍数](https://leetcode-cn.com/problems/largest-multiple-of-three)|困难:zzz:|贪心、数组、动态规划|:vertical_traffic_light:TODO|
|1278|指定日期的产品价格 :closed_lock_with_key:|中等:speech_balloon:|数据库|:vertical_traffic_light:TODO|
...
|1366|第一个唯一数字 :closed_lock_with_key:|中等:speech_balloon:|设计、队列、数组、哈希表、数据流|:vertical_traffic_light:TODO|
|1367|:point_right:[堆叠长方体的最大高度](https://leetcode-cn.com/problems/maximum-height-by-stacking-cuboids)|困难:zzz:|数组、动态规划、排序|:vertical_traffic_light:TODO|
|1368|多线程网页爬虫 :closed_lock_with_key:|中等:speech_balloon:|深度优先搜索、广度优先搜索、多线程|:vertical_traffic_light:TODO|
|1369|:point_right:[交换字符使得字符串相同](https://leetcode-cn.com/problems/minimum-swaps-to-make-strings-equal)|中等:speech_balloon:|贪心、数学、字符串|:vertical_traffic_light:TODO|
|1370|:point_right:[统计「优美子数组」](https://leetcode-cn.com/problems/count-number-of-nice-subarrays)|中等:speech_balloon:|数组、哈希表、数学、滑动窗口|:vertical_traffic_light:TODO|
|1371|:point_right:[移除无效的括号](https://leetcode-cn.com/problems/minimum-remove-to-make-valid-parentheses)|中等:speech_balloon:|栈、字符串|:vertical_traffic_light:TODO|
|1372|:point_right:[检查「好数组」](https://leetcode-cn.com/problems/check-if-it-is-a-good-array)|困难:zzz:|数组、数学、数论|:vertical_traffic_light:TODO|
|1374|至少有一个 1 的最左端列 :closed_lock_with_key:|中等:speech_balloon:|数组、二分查找、交互、矩阵|:vertical_traffic_light:TODO|
|1377|每个帖子的评论数 :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|1378|:point_right:[奇数值单元格的数目](https://leetcode-cn.com/problems/cells-with-odd-values-in-a-matrix)|简单:bulb:|数组、数学、模拟|:vertical_traffic_light:TODO|
...
|1391|数元素 :closed_lock_with_key:|简单:bulb:|数组、哈希表|:vertical_traffic_light:TODO|
...
|1402|:point_right:[统计全为 1 的正方形子矩阵](https://leetcode-cn.com/problems/count-square-submatrices-with-all-ones)|中等:speech_balloon:|数组、动态规划、矩阵|:vertical_traffic_light:TODO|
...
|1425|不同国家的天气类型 :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|1426|:point_right:[和为零的N个唯一整数](https://leetcode-cn.com/problems/find-n-unique-integers-sum-up-to-zero)|简单:bulb:|数组、数学|:vertical_traffic_light:TODO|
...
|1476|:point_right:[统计有序矩阵中的负数](https://leetcode-cn.com/problems/count-negative-numbers-in-a-sorted-matrix)|简单:bulb:|数组、二分查找、矩阵|:vertical_traffic_light:TODO|
|1477|:point_right:[最后 K 个数的乘积](https://leetcode-cn.com/problems/product-of-the-last-k-numbers)|中等:speech_balloon:|设计、队列、数组、数学、数据流|:vertical_traffic_light:TODO|
|1478|:point_right:[最多可以参加的会议数目](https://leetcode-cn.com/problems/maximum-number-of-events-that-can-be-attended)|中等:speech_balloon:|贪心、数组、堆（优先队列）|:vertical_traffic_light:TODO|
...
|1486|:point_right:[两个数组间的距离值](https://leetcode-cn.com/problems/find-the-distance-value-between-two-arrays)|简单:bulb:|数组、双指针、二分查找、排序|:vertical_traffic_light:TODO|
|1487|:point_right:[安排电影院座位](https://leetcode-cn.com/problems/cinema-seat-allocation)|中等:speech_balloon:|贪心、位运算、数组、哈希表|:vertical_traffic_light:TODO|
...
|1500|:point_right:[统计最大组的数目](https://leetcode-cn.com/problems/count-largest-group)|简单:bulb:|哈希表、数学|:vertical_traffic_light:TODO|
|1501|:point_right:[圆和矩形是否有重叠](https://leetcode-cn.com/problems/circle-and-rectangle-overlapping)|中等:speech_balloon:|几何、数学|:vertical_traffic_light:TODO|
|1502|:point_right:[构造 K 个回文字符串](https://leetcode-cn.com/problems/construct-k-palindrome-strings)|中等:speech_balloon:|贪心、哈希表、字符串、计数|:vertical_traffic_light:TODO|
|1503|:point_right:[做菜顺序](https://leetcode-cn.com/problems/reducing-dishes)|困难:zzz:|贪心、数组、动态规划、排序|:vertical_traffic_light:TODO|
...
|1519|:point_right:[非递增顺序的最小子序列](https://leetcode-cn.com/problems/minimum-subsequence-in-non-increasing-order)|简单:bulb:|贪心、数组、排序|:vertical_traffic_light:TODO|
|1520|:point_right:[将二进制表示减到 1 的步骤数](https://leetcode-cn.com/problems/number-of-steps-to-reduce-a-number-in-binary-representation-to-one)|中等:speech_balloon:|位运算、字符串|:vertical_traffic_light:TODO|
|1522|:point_right:[石子游戏 III](https://leetcode-cn.com/problems/stone-game-iii)|困难:zzz:|数组、数学、动态规划、博弈|:vertical_traffic_light:TODO|
|1523|股票的资本损益 :closed_lock_with_key:|中等:speech_balloon:|数据库|:vertical_traffic_light:TODO|
|1524|:point_right:[数组中的字符串匹配](https://leetcode-cn.com/problems/string-matching-in-an-array)|简单:bulb:|字符串、字符串匹配|:vertical_traffic_light:TODO|
|1525|:point_right:[查询带键的排列](https://leetcode-cn.com/problems/queries-on-a-permutation-with-key)|中等:speech_balloon:|树状数组、数组、模拟|:vertical_traffic_light:TODO|
|1526|:point_right:[HTML 实体解析器](https://leetcode-cn.com/problems/html-entity-parser)|中等:speech_balloon:|哈希表、字符串|:vertical_traffic_light:TODO|
|1527|:point_right:[给 N x 3 网格图涂色的方案数](https://leetcode-cn.com/problems/number-of-ways-to-paint-n-3-grid)|困难:zzz:|动态规划|:vertical_traffic_light:TODO|
|1528|:point_right:[拥有最多糖果的孩子](https://leetcode-cn.com/problems/kids-with-the-greatest-number-of-candies)|简单:bulb:|数组|:vertical_traffic_light:TODO|
|1529|:point_right:[改变一个整数能得到的最大差值](https://leetcode-cn.com/problems/max-difference-you-can-get-from-changing-an-integer)|中等:speech_balloon:|贪心、数学|:vertical_traffic_light:TODO|
...
|1557|:point_right:[检查一个字符串是否包含所有长度为 K 的二进制子串](https://leetcode-cn.com/problems/check-if-a-string-contains-all-binary-codes-of-size-k)|中等:speech_balloon:|位运算、哈希表、字符串、哈希函数、滚动哈希|:vertical_traffic_light:TODO|
|1558|:point_right:[课程表 IV](https://leetcode-cn.com/problems/course-schedule-iv)|中等:speech_balloon:|深度优先搜索、广度优先搜索、图、拓扑排序|:vertical_traffic_light:TODO|
|1559|:point_right:[摘樱桃 II](https://leetcode-cn.com/problems/cherry-pickup-ii)|困难:zzz:|数组、动态规划、矩阵|:vertical_traffic_light:TODO|
|1560|:point_right:[在既定时间做作业的学生人数](https://leetcode-cn.com/problems/number-of-students-doing-homework-at-a-given-time)|简单:bulb:|数组|:vertical_traffic_light:TODO|
|1561|:point_right:[重新排列句子中的单词](https://leetcode-cn.com/problems/rearrange-words-in-a-sentence)|中等:speech_balloon:|字符串、排序|:vertical_traffic_light:TODO|
|1562|:point_right:[收藏清单](https://leetcode-cn.com/problems/people-whose-list-of-favorite-companies-is-not-a-subset-of-another-list)|中等:speech_balloon:|数组、哈希表、字符串|:vertical_traffic_light:TODO|
|1563|:point_right:[圆形靶内的最大飞镖数量](https://leetcode-cn.com/problems/maximum-number-of-darts-inside-of-a-circular-dartboard)|困难:zzz:|几何、数组、数学|:vertical_traffic_light:TODO|
|1564|制作会话柱状图 :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|1565|计算布尔表达式的值 :closed_lock_with_key:|中等:speech_balloon:|数据库|:vertical_traffic_light:TODO|
|1566|:point_right:[检查单词是否为句中其他单词的前缀](https://leetcode-cn.com/problems/check-if-a-word-occurs-as-a-prefix-of-any-word-in-a-sentence)|简单:bulb:|字符串、字符串匹配|:vertical_traffic_light:TODO|
|1567|:point_right:[定长子串中元音的最大数目](https://leetcode-cn.com/problems/maximum-number-of-vowels-in-a-substring-of-given-length)|中等:speech_balloon:|字符串、滑动窗口|:vertical_traffic_light:TODO|
|1568|:point_right:[二叉树中的伪回文路径](https://leetcode-cn.com/problems/pseudo-palindromic-paths-in-a-binary-tree)|中等:speech_balloon:|位运算、树、深度优先搜索、广度优先搜索、二叉树|:vertical_traffic_light:TODO|
...
|1576|:point_right:[重新规划路线](https://leetcode-cn.com/problems/reorder-routes-to-make-all-paths-lead-to-the-city-zero)|中等:speech_balloon:|深度优先搜索、广度优先搜索、图|:vertical_traffic_light:TODO|
...
|1618|删除链表 M 个节点之后的 N 个节点 :closed_lock_with_key:|简单:bulb:|链表|:vertical_traffic_light:TODO|
|1619|:point_right:[判断路径是否相交](https://leetcode-cn.com/problems/path-crossing)|简单:bulb:|哈希表、字符串|:vertical_traffic_light:TODO|
|1620|:point_right:[检查数组对是否可以被 k 整除](https://leetcode-cn.com/problems/check-if-array-pairs-are-divisible-by-k)|中等:speech_balloon:|数组、哈希表、计数|:vertical_traffic_light:TODO|
|1621|:point_right:[满足条件的子序列数目](https://leetcode-cn.com/problems/number-of-subsequences-that-satisfy-the-given-sum-condition)|中等:speech_balloon:|数组、双指针、二分查找、排序|:vertical_traffic_light:TODO|
|1622|:point_right:[满足不等式的最大值](https://leetcode-cn.com/problems/max-value-of-equation)|困难:zzz:|队列、数组、滑动窗口、单调队列、堆（优先队列）|:vertical_traffic_light:TODO|
|1623|周内每天的销售情况 :closed_lock_with_key:|困难:zzz:|数据库|:vertical_traffic_light:TODO|
|1624|克隆含随机指针的二叉树 :closed_lock_with_key:|中等:speech_balloon:|树、深度优先搜索、广度优先搜索、哈希表、二叉树|:vertical_traffic_light:TODO|
|1625|按日期分组销售产品 :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|1626|:point_right:[判断能否形成等差数列](https://leetcode-cn.com/problems/can-make-arithmetic-progression-from-sequence)|简单:bulb:|数组、排序|:vertical_traffic_light:TODO|
|1627|:point_right:[所有蚂蚁掉下来前的最后一刻](https://leetcode-cn.com/problems/last-moment-before-all-ants-fall-out-of-a-plank)|中等:speech_balloon:|脑筋急转弯、数组、模拟|:vertical_traffic_light:TODO|
|1628|:point_right:[统计全 1 子矩形](https://leetcode-cn.com/problems/count-submatrices-with-all-ones)|中等:speech_balloon:|栈、数组、动态规划、矩阵、单调栈|:vertical_traffic_light:TODO|
|1629|:point_right:[最多 K 次交换相邻数位后得到的最小整数](https://leetcode-cn.com/problems/minimum-possible-integer-after-at-most-k-adjacent-swaps-on-digits)|困难:zzz:|贪心、树状数组、线段树、字符串|:vertical_traffic_light:TODO|
|1630|:point_right:[在区间范围内统计奇数数目](https://leetcode-cn.com/problems/count-odd-numbers-in-an-interval-range)|简单:bulb:|数学|:vertical_traffic_light:TODO|
|1631|:point_right:[和为奇数的子数组数目](https://leetcode-cn.com/problems/number-of-sub-arrays-with-odd-sum)|中等:speech_balloon:|数组、数学、动态规划、前缀和|:vertical_traffic_light:TODO|
...
|1647|:point_right:[K 次操作转变字符串](https://leetcode-cn.com/problems/can-convert-string-in-k-moves)|中等:speech_balloon:|哈希表、字符串|:vertical_traffic_light:TODO|
|1648|:point_right:[平衡括号字符串的最少插入次数](https://leetcode-cn.com/problems/minimum-insertions-to-balance-a-parentheses-string)|中等:speech_balloon:|栈、贪心、字符串|:vertical_traffic_light:TODO|
...
|1656|:point_right:[统计好三元组](https://leetcode-cn.com/problems/count-good-triplets)|简单:bulb:|数组、枚举|:vertical_traffic_light:TODO|
|1657|:point_right:[找出数组游戏的赢家](https://leetcode-cn.com/problems/find-the-winner-of-an-array-game)|中等:speech_balloon:|数组、模拟|:vertical_traffic_light:TODO|
|1658|:point_right:[排布二进制网格的最少交换次数](https://leetcode-cn.com/problems/minimum-swaps-to-arrange-a-binary-grid)|中等:speech_balloon:|贪心、数组、矩阵|:vertical_traffic_light:TODO|
|1659|:point_right:[最大得分](https://leetcode-cn.com/problems/get-the-maximum-score)|困难:zzz:|贪心、数组、双指针、动态规划|:vertical_traffic_light:TODO|
...
|1667|:point_right:[找出第 N 个二进制字符串中的第 K 位](https://leetcode-cn.com/problems/find-kth-bit-in-nth-binary-string)|中等:speech_balloon:|递归、字符串|:vertical_traffic_light:TODO|
|1668|:point_right:[找出最长的超赞子字符串](https://leetcode-cn.com/problems/find-longest-awesome-substring)|困难:zzz:|位运算、哈希表、字符串|:vertical_traffic_light:TODO|
|1669|:point_right:[切棍子的最小成本](https://leetcode-cn.com/problems/minimum-cost-to-cut-a-stick)|困难:zzz:|数组、动态规划|:vertical_traffic_light:TODO|
|1670|患某种疾病的患者 :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|1671|最近的三笔订单 :closed_lock_with_key:|中等:speech_balloon:|数据库|:vertical_traffic_light:TODO|
|1672|找到最大整数的索引 :closed_lock_with_key:|中等:speech_balloon:|数组、二分查找、交互|:vertical_traffic_light:TODO|
|1674|:point_right:[使数组中所有元素相等的最小操作数](https://leetcode-cn.com/problems/minimum-operations-to-make-array-equal)|中等:speech_balloon:|数学|:vertical_traffic_light:TODO|
|1675|:point_right:[两球之间的磁力](https://leetcode-cn.com/problems/magnetic-force-between-two-balls)|中等:speech_balloon:|数组、二分查找、排序|:vertical_traffic_light:TODO|
|1676|:point_right:[吃掉 N 个橘子的最少天数](https://leetcode-cn.com/problems/minimum-number-of-days-to-eat-n-oranges)|困难:zzz:|记忆化搜索、动态规划|:vertical_traffic_light:TODO|
|1677|:point_right:[矩阵对角线元素的和](https://leetcode-cn.com/problems/matrix-diagonal-sum)|简单:bulb:|数组、矩阵|:vertical_traffic_light:TODO|
|1678|:point_right:[分割字符串的方案数](https://leetcode-cn.com/problems/number-of-ways-to-split-a-string)|中等:speech_balloon:|数学、字符串|:vertical_traffic_light:TODO|
|1679|:point_right:[删除最短的子数组使剩余数组有序](https://leetcode-cn.com/problems/shortest-subarray-to-be-removed-to-make-array-sorted)|中等:speech_balloon:|栈、数组、双指针、二分查找、单调栈|:vertical_traffic_light:TODO|
|1680|:point_right:[统计所有可行路径](https://leetcode-cn.com/problems/count-all-possible-routes)|困难:zzz:|记忆化搜索、数组、动态规划|:vertical_traffic_light:TODO|
|1681|找出隐藏数组中出现次数最多的元素 :closed_lock_with_key:|中等:speech_balloon:|数组、数学、交互|:vertical_traffic_light:TODO|
|1682|:point_right:[圆形赛道上经过次数最多的扇区](https://leetcode-cn.com/problems/most-visited-sector-in-a-circular-track)|简单:bulb:|数组、模拟|:vertical_traffic_light:TODO|
|1683|:point_right:[你可以获得的最大硬币数目](https://leetcode-cn.com/problems/maximum-number-of-coins-you-can-get)|中等:speech_balloon:|贪心、数组、数学、博弈、排序|:vertical_traffic_light:TODO|
|1684|:point_right:[查找大小为 M 的最新分组](https://leetcode-cn.com/problems/find-latest-group-of-size-m)|中等:speech_balloon:|数组、二分查找、模拟|:vertical_traffic_light:TODO|
|1685|:point_right:[石子游戏 V](https://leetcode-cn.com/problems/stone-game-v)|困难:zzz:|数组、数学、动态规划、博弈|:vertical_traffic_light:TODO|
|1686|产品名称格式修复 :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|1687|图中最相似的路径 :closed_lock_with_key:|困难:zzz:|图、动态规划|:vertical_traffic_light:TODO|
|1688|每件商品的最新订单 :closed_lock_with_key:|中等:speech_balloon:|数据库|:vertical_traffic_light:TODO|
|1689|:point_right:[重复至少 K 次且长度为 M 的模式](https://leetcode-cn.com/problems/detect-pattern-of-length-m-repeated-k-or-more-times)|简单:bulb:|数组、枚举|:vertical_traffic_light:TODO|
...
|1712|按月统计订单数与顾客数 :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|1713|两个稀疏向量的点积 :closed_lock_with_key:|中等:speech_balloon:|设计、数组、哈希表、双指针|:vertical_traffic_light:TODO|
|1714|:point_right:[重新排列单词间的空格](https://leetcode-cn.com/problems/rearrange-spaces-between-words)|简单:bulb:|字符串|:vertical_traffic_light:TODO|
|1715|:point_right:[拆分字符串使唯一子字符串的数目最大](https://leetcode-cn.com/problems/split-a-string-into-the-max-number-of-unique-substrings)|中等:speech_balloon:|哈希表、字符串、回溯|:vertical_traffic_light:TODO|
|1716|:point_right:[矩阵的最大非负积](https://leetcode-cn.com/problems/maximum-non-negative-product-in-a-matrix)|中等:speech_balloon:|数组、动态规划、矩阵|:vertical_traffic_light:TODO|
|1717|:point_right:[连通两组点的最小成本](https://leetcode-cn.com/problems/minimum-cost-to-connect-two-groups-of-points)|困难:zzz:|位运算、数组、动态规划、状态压缩、矩阵|:vertical_traffic_light:TODO|
|1718|仓库经理 :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
...
|1741|:point_right:[按照频率将数组升序排序](https://leetcode-cn.com/problems/sort-array-by-increasing-frequency)|简单:bulb:|数组、哈希表、排序|:vertical_traffic_light:TODO|
|1742|:point_right:[两点之间不包含任何点的最宽垂直面积](https://leetcode-cn.com/problems/widest-vertical-area-between-two-points-containing-no-points)|中等:speech_balloon:|数组、排序|:vertical_traffic_light:TODO|
|1743|:point_right:[统计只差一个字符的子串数目](https://leetcode-cn.com/problems/count-substrings-that-differ-by-one-character)|中等:speech_balloon:|哈希表、字符串、动态规划|:vertical_traffic_light:TODO|
|1744|:point_right:[通过给定词典构造目标字符串的方案数](https://leetcode-cn.com/problems/number-of-ways-to-form-a-target-string-given-a-dictionary)|困难:zzz:|数组、字符串、动态规划|:vertical_traffic_light:TODO|
|1745|找到二叉树中最近的右侧节点 :closed_lock_with_key:|中等:speech_balloon:|树、广度优先搜索、二叉树|:vertical_traffic_light:TODO|
|1746|:point_right:[两个相同字符之间的最长子字符串](https://leetcode-cn.com/problems/largest-substring-between-two-equal-characters)|简单:bulb:|哈希表、字符串|:vertical_traffic_light:TODO|
|1747|:point_right:[执行操作后字典序最小的字符串](https://leetcode-cn.com/problems/lexicographically-smallest-string-after-applying-operations)|中等:speech_balloon:|广度优先搜索、字符串|:vertical_traffic_light:TODO|
...
|1758|:point_right:[分配重复整数](https://leetcode-cn.com/problems/distribute-repeating-integers)|困难:zzz:|位运算、数组、动态规划、回溯、状态压缩|:vertical_traffic_light:TODO|
|1759|找到遗失的ID :closed_lock_with_key:|中等:speech_balloon:|数据库|:vertical_traffic_light:TODO|
|1760|:point_right:[能否连接形成数组](https://leetcode-cn.com/problems/check-array-formation-through-concatenation)|简单:bulb:|数组、哈希表|:vertical_traffic_light:TODO|
|1761|:point_right:[统计字典序元音字符串的数目](https://leetcode-cn.com/problems/count-sorted-vowel-strings)|中等:speech_balloon:|动态规划|:vertical_traffic_light:TODO|
|1762|:point_right:[可以到达的最远建筑](https://leetcode-cn.com/problems/furthest-building-you-can-reach)|中等:speech_balloon:|贪心、数组、堆（优先队列）|:vertical_traffic_light:TODO|
|1763|三人国家代表队 :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|1764|:point_right:[最大重复子字符串](https://leetcode-cn.com/problems/maximum-repeating-substring)|简单:bulb:|字符串、字符串匹配|:vertical_traffic_light:TODO|
|1765|:point_right:[合并两个链表](https://leetcode-cn.com/problems/merge-in-between-linked-lists)|中等:speech_balloon:|链表|:vertical_traffic_light:TODO|
...
|1780|二叉树的最近公共祖先 II :closed_lock_with_key:|中等:speech_balloon:|树、深度优先搜索、二叉树|:vertical_traffic_light:TODO|
|1781|:point_right:[检查两个字符串数组是否相等](https://leetcode-cn.com/problems/check-if-two-string-arrays-are-equivalent)|简单:bulb:|数组、字符串|:vertical_traffic_light:TODO|
|1782|:point_right:[具有给定数值的最小字符串](https://leetcode-cn.com/problems/smallest-string-with-a-given-numeric-value)|中等:speech_balloon:|贪心、字符串|:vertical_traffic_light:TODO|
|1783|:point_right:[生成平衡数组的方案数](https://leetcode-cn.com/problems/ways-to-make-a-fair-array)|中等:speech_balloon:|数组、动态规划|:vertical_traffic_light:TODO|
|1784|:point_right:[完成所有任务的最少初始能量](https://leetcode-cn.com/problems/minimum-initial-energy-to-finish-tasks)|困难:zzz:|贪心、数组、排序|:vertical_traffic_light:TODO|
|1785|没有找到中文名:ab: :closed_lock_with_key:|困难:zzz:|数据库|:vertical_traffic_light:TODO|
|1786|:point_right:[统计一致字符串的数目](https://leetcode-cn.com/problems/count-the-number-of-consistent-strings)|简单:bulb:|位运算、数组、哈希表、字符串|:vertical_traffic_light:TODO|
|1787|:point_right:[有序数组中差绝对值之和](https://leetcode-cn.com/problems/sum-of-absolute-differences-in-a-sorted-array)|中等:speech_balloon:|数组、数学、前缀和|:vertical_traffic_light:TODO|
...
|1801|每台机器的进程平均运行时间 :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|1802|:point_right:[无法吃午餐的学生数量](https://leetcode-cn.com/problems/number-of-students-unable-to-eat-lunch)|简单:bulb:|栈、队列、数组、模拟|:vertical_traffic_light:TODO|
...
|1880|:point_right:[构造字典序最大的合并字符串](https://leetcode-cn.com/problems/largest-merge-of-two-strings)|中等:speech_balloon:|贪心、双指针、字符串|:vertical_traffic_light:TODO|
|1881|:point_right:[最接近目标值的子序列和](https://leetcode-cn.com/problems/closest-subsequence-sum)|困难:zzz:|位运算、数组、双指针、动态规划、状态压缩|:vertical_traffic_light:TODO|
|1882|每位经理的下属员工数量 :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|1883|找到二叉树中的距离 :closed_lock_with_key:|中等:speech_balloon:|树、深度优先搜索、广度优先搜索、哈希表、二叉树|:vertical_traffic_light:TODO|
|1884|:point_right:[生成交替二进制字符串的最少操作数](https://leetcode-cn.com/problems/minimum-changes-to-make-alternating-binary-string)|简单:bulb:|字符串|:vertical_traffic_light:TODO|
|1885|:point_right:[统计同构子字符串的数目](https://leetcode-cn.com/problems/count-number-of-homogenous-substrings)|中等:speech_balloon:|数学、字符串|:vertical_traffic_light:TODO|
|1886|:point_right:[袋子里最少数目的球](https://leetcode-cn.com/problems/minimum-limit-of-balls-in-a-bag)|中等:speech_balloon:|数组、二分查找|:vertical_traffic_light:TODO|
|1887|:point_right:[一个图中连通三元组的最小度数](https://leetcode-cn.com/problems/minimum-degree-of-a-connected-trio-in-a-graph)|困难:zzz:|图|:vertical_traffic_light:TODO|
|1888|:point_right:[找到最近的有相同 X 或 Y 坐标的点](https://leetcode-cn.com/problems/find-nearest-point-that-has-the-same-x-or-y-coordinate)|简单:bulb:|数组|:vertical_traffic_light:TODO|
|1889|:point_right:[判断一个数字是否可以表示成三的幂的和](https://leetcode-cn.com/problems/check-if-number-is-a-sum-of-powers-of-three)|中等:speech_balloon:|数学|:vertical_traffic_light:TODO|
|1890|:point_right:[所有子字符串美丽值之和](https://leetcode-cn.com/problems/sum-of-beauty-of-all-substrings)|中等:speech_balloon:|哈希表、字符串、计数|:vertical_traffic_light:TODO|
|1891|:point_right:[统计点对的数目](https://leetcode-cn.com/problems/count-pairs-of-nodes)|困难:zzz:|图、双指针、二分查找|:vertical_traffic_light:TODO|
|1892|查找每个员工花费的总时间 :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|1893|经过一次操作后的最大子数组和 :closed_lock_with_key:|中等:speech_balloon:|数组、动态规划|:vertical_traffic_light:TODO|
|1894|:point_right:[交替合并字符串](https://leetcode-cn.com/problems/merge-strings-alternately)|简单:bulb:|双指针、字符串|:vertical_traffic_light:TODO|
|1895|:point_right:[移动所有球到每个盒子所需的最小操作数](https://leetcode-cn.com/problems/minimum-number-of-operations-to-move-all-balls-to-each-box)|中等:speech_balloon:|数组、字符串|:vertical_traffic_light:TODO|
|1896|:point_right:[执行乘法运算的最大分数](https://leetcode-cn.com/problems/maximum-score-from-performing-multiplication-operations)|中等:speech_balloon:|数组、动态规划|:vertical_traffic_light:TODO|
|1897|:point_right:[由子序列构造的最长回文串的长度](https://leetcode-cn.com/problems/maximize-palindrome-length-from-subsequences)|困难:zzz:|字符串、动态规划|:vertical_traffic_light:TODO|
|1898|应该被禁止的Leetflex账户 :closed_lock_with_key:|中等:speech_balloon:|数据库|:vertical_traffic_light:TODO|
|1899|:point_right:[统计匹配检索规则的物品数量](https://leetcode-cn.com/problems/count-items-matching-a-rule)|简单:bulb:|数组、字符串|:vertical_traffic_light:TODO|
...
|1907|:point_right:[统计异或值在范围内的数对有多少](https://leetcode-cn.com/problems/count-pairs-with-xor-in-a-range)|困难:zzz:|位运算、字典树、数组|:vertical_traffic_light:TODO|
|1908|可回收且低脂的产品 :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|1909|能看到海景的建筑物 :closed_lock_with_key:|中等:speech_balloon:|栈、数组、单调栈|:vertical_traffic_light:TODO|
...
|1924|:point_right:[得到新鲜甜甜圈的最多组数](https://leetcode-cn.com/problems/maximum-number-of-groups-getting-fresh-donuts)|困难:zzz:|位运算、记忆化搜索、数组、动态规划、状态压缩|:vertical_traffic_light:TODO|
|1925|:point_right:[统计一个数组中好对子的数目](https://leetcode-cn.com/problems/count-nice-pairs-in-an-array)|中等:speech_balloon:|数组、哈希表、数学、计数|:vertical_traffic_light:TODO|
|1926|每家商店的产品价格 :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|1927|:point_right:[最大升序子数组和](https://leetcode-cn.com/problems/maximum-ascending-subarray-sum)|简单:bulb:|数组|:vertical_traffic_light:TODO|
|1928|:point_right:[积压订单中的订单总数](https://leetcode-cn.com/problems/number-of-orders-in-the-backlog)|中等:speech_balloon:|数组、模拟、堆（优先队列）|:vertical_traffic_light:TODO|
|1929|:point_right:[有界数组中指定下标处的最大值](https://leetcode-cn.com/problems/maximum-value-at-a-given-index-in-a-bounded-array)|中等:speech_balloon:|贪心、二分查找|:vertical_traffic_light:TODO|
...
|1940|:point_right:[每个查询的最大异或值](https://leetcode-cn.com/problems/maximum-xor-for-each-query)|中等:speech_balloon:|位运算、数组、前缀和|:vertical_traffic_light:TODO|
...
|1972|:point_right:[旋转盒子](https://leetcode-cn.com/problems/rotating-the-box)|中等:speech_balloon:|数组、双指针、矩阵|:vertical_traffic_light:TODO|
|1974|寻找今年具有正收入的客户 :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|1975|:point_right:[到目标元素的最小距离](https://leetcode-cn.com/problems/minimum-distance-to-the-target-element)|简单:bulb:|数组|:vertical_traffic_light:TODO|
...
|2021|:point_right:[删除一个字符串中所有出现的给定子字符串](https://leetcode-cn.com/problems/remove-all-occurrences-of-a-substring)|中等:speech_balloon:|字符串|:vertical_traffic_light:TODO|
|2022|:point_right:[最大子序列交替和](https://leetcode-cn.com/problems/maximum-alternating-subsequence-sum)|中等:speech_balloon:|数组、动态规划|:vertical_traffic_light:TODO|
|2023|:point_right:[设计电影租借系统](https://leetcode-cn.com/problems/design-movie-rental-system)|困难:zzz:|设计、数组、哈希表、有序集合、堆（优先队列）|:vertical_traffic_light:TODO|
|2024|计算特殊奖金 :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|2025|:point_right:[重新分配字符使所有字符串都相等](https://leetcode-cn.com/problems/redistribute-characters-to-make-all-strings-equal)|简单:bulb:|哈希表、字符串、计数|:vertical_traffic_light:TODO|
|2026|:point_right:[合并若干三元组以形成目标三元组](https://leetcode-cn.com/problems/merge-triplets-to-form-target-triplet)|中等:speech_balloon:|贪心、数组|:vertical_traffic_light:TODO|
...
|2040|:point_right:[规定时间内到达终点的最小花费](https://leetcode-cn.com/problems/minimum-cost-to-reach-destination-in-time)|困难:zzz:|图、动态规划|:vertical_traffic_light:TODO|
|2041|2020年最后一次登录 :closed_lock_with_key:|简单:bulb:|数据库|:vertical_traffic_light:TODO|
|2042|:point_right:[两个数对之间的最大乘积差](https://leetcode-cn.com/problems/maximum-product-difference-between-two-pairs)|简单:bulb:|数组、排序|:vertical_traffic_light:TODO|
|2043|:point_right:[循环轮转矩阵](https://leetcode-cn.com/problems/cyclically-rotating-a-grid)|中等:speech_balloon:|数组、矩阵、模拟|:vertical_traffic_light:TODO|
|2044|:point_right:[最美子字符串的数目](https://leetcode-cn.com/problems/number-of-wonderful-substrings)|中等:speech_balloon:|位运算、哈希表、字符串、前缀和|:vertical_traffic_light:TODO|
|2045|割绳子 :closed_lock_with_key:|中等:speech_balloon:|数组、二分查找|:vertical_traffic_light:TODO|
|2046|页面推荐Ⅱ :closed_lock_with_key:|困难:zzz:|数据库|:vertical_traffic_light:TODO|
|2047|:point_right:[找出顶峰元素 II](https://leetcode-cn.com/problems/find-a-peak-element-ii)|中等:speech_balloon:|数组、二分查找、分治、矩阵|:vertical_traffic_light:TODO|
|2048|:point_right:[基于排列构建数组](https://leetcode-cn.com/problems/build-array-from-permutation)|简单:bulb:|数组、模拟|:vertical_traffic_light:TODO|
...
|100096|:point_right:[机器人大冒险](https://leetcode-cn.com/problems/programmable-robot)|中等:speech_balloon:|数组、哈希表、模拟|:vertical_traffic_light:TODO|
|100107|:point_right:[猜数字](https://leetcode-cn.com/problems/guess-numbers)|简单:bulb:|数组|:vertical_traffic_light:TODO|
|100158|:point_right:[判定字符是否唯一](https://leetcode-cn.com/problems/is-unique-lcci)|简单:bulb:|位运算、哈希表、字符串、排序|:vertical_traffic_light:TODO|
|100159|:point_right:[判定是否互为字符重排](https://leetcode-cn.com/problems/check-permutation-lcci)|简单:bulb:|哈希表、字符串、排序|:truck:[Cpp](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/100159.check-permutation-lcci.cpp)|
|100160|:point_right:[URL化](https://leetcode-cn.com/problems/string-to-url-lcci)|简单:bulb:|字符串|:vertical_traffic_light:TODO|
|100161|:point_right:[字符串压缩](https://leetcode-cn.com/problems/compress-string-lcci)|简单:bulb:|双指针、字符串|:vertical_traffic_light:TODO|
|100162|:point_right:[字符串轮转](https://leetcode-cn.com/problems/string-rotation-lcci)|简单:bulb:|字符串、字符串匹配|:vertical_traffic_light:TODO|
|100163|:point_right:[移除重复节点](https://leetcode-cn.com/problems/remove-duplicate-node-lcci)|简单:bulb:|哈希表、链表、双指针|:vertical_traffic_light:TODO|
|100164|:point_right:[回文链表](https://leetcode-cn.com/problems/palindrome-linked-list-lcci)|简单:bulb:|栈、递归、链表、双指针|:vertical_traffic_light:TODO|
|100167|:point_right:[链表相交](https://leetcode-cn.com/problems/intersection-of-two-linked-lists-lcci)|简单:bulb:|哈希表、链表、双指针|:vertical_traffic_light:TODO|
|100168|:point_right:[环路检测](https://leetcode-cn.com/problems/linked-list-cycle-lcci)|中等:speech_balloon:|哈希表、链表、双指针|:vertical_traffic_light:TODO|
|100169|:point_right:[栈的最小值](https://leetcode-cn.com/problems/min-stack-lcci)|简单:bulb:|栈、设计|:vertical_traffic_light:TODO|
|100170|:point_right:[化栈为队](https://leetcode-cn.com/problems/implement-queue-using-stacks-lcci)|简单:bulb:|栈、设计、队列|:vertical_traffic_light:TODO|
|100171|:point_right:[节点间通路](https://leetcode-cn.com/problems/route-between-nodes-lcci)|中等:speech_balloon:|深度优先搜索、广度优先搜索、图|:vertical_traffic_light:TODO|
|100172|:point_right:[三合一](https://leetcode-cn.com/problems/three-in-one-lcci)|简单:bulb:|栈、设计、数组|:vertical_traffic_light:TODO|
|100173|:point_right:[栈排序](https://leetcode-cn.com/problems/sort-of-stacks-lcci)|中等:speech_balloon:|栈、设计、单调栈|:vertical_traffic_light:TODO|
|100174|:point_right:[最小高度树](https://leetcode-cn.com/problems/minimum-height-tree-lcci)|简单:bulb:|树、二叉搜索树、数组、分治、二叉树|:vertical_traffic_light:TODO|
|100175|:point_right:[特定深度节点链表](https://leetcode-cn.com/problems/list-of-depth-lcci)|中等:speech_balloon:|树、广度优先搜索、链表、二叉树|:vertical_traffic_light:TODO|
|100176|:point_right:[检查平衡性](https://leetcode-cn.com/problems/check-balance-lcci)|简单:bulb:|树、深度优先搜索、二叉树|:vertical_traffic_light:TODO|
|100177|:point_right:[合法二叉搜索树](https://leetcode-cn.com/problems/legal-binary-search-tree-lcci)|中等:speech_balloon:|树、深度优先搜索、二叉搜索树、二叉树|:vertical_traffic_light:TODO|
|100178|:point_right:[后继者](https://leetcode-cn.com/problems/successor-lcci)|中等:speech_balloon:|树、深度优先搜索、二叉搜索树、二叉树|:vertical_traffic_light:TODO|
|100179|:point_right:[首个共同祖先](https://leetcode-cn.com/problems/first-common-ancestor-lcci)|中等:speech_balloon:|树、深度优先搜索、二叉树|:vertical_traffic_light:TODO|
|100180|:point_right:[插入](https://leetcode-cn.com/problems/insert-into-bits-lcci)|简单:bulb:|位运算|:vertical_traffic_light:TODO|
|100181|:point_right:[整数转换](https://leetcode-cn.com/problems/convert-integer-lcci)|简单:bulb:|位运算|:vertical_traffic_light:TODO|
|100182|:point_right:[配对交换](https://leetcode-cn.com/problems/exchange-lcci)|简单:bulb:|位运算|:vertical_traffic_light:TODO|
|100183|:point_right:[下一个数](https://leetcode-cn.com/problems/closed-number-lcci)|中等:speech_balloon:|位运算|:vertical_traffic_light:TODO|
|100184|:point_right:[回文排列](https://leetcode-cn.com/problems/palindrome-permutation-lcci)|简单:bulb:|位运算、哈希表、字符串|:vertical_traffic_light:TODO|
|100185|:point_right:[旋转矩阵](https://leetcode-cn.com/problems/rotate-matrix-lcci)|中等:speech_balloon:|数组、数学、矩阵|:vertical_traffic_light:TODO|
|100186|:point_right:[零矩阵](https://leetcode-cn.com/problems/zero-matrix-lcci)|中等:speech_balloon:|数组、哈希表、矩阵|:vertical_traffic_light:TODO|
|100187|:point_right:[删除中间节点](https://leetcode-cn.com/problems/delete-middle-node-lcci)|简单:bulb:|链表|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/100187.delete-middle-node-lcci.java)|
|100188|:point_right:[链表求和](https://leetcode-cn.com/problems/sum-lists-lcci)|中等:speech_balloon:|递归、链表、数学|:vertical_traffic_light:TODO|
|100195|:point_right:[堆盘子](https://leetcode-cn.com/problems/stack-of-plates-lcci)|中等:speech_balloon:|栈、设计、链表|:vertical_traffic_light:TODO|
|100196|:point_right:[绘制直线](https://leetcode-cn.com/problems/draw-line-lcci)|中等:speech_balloon:|位运算、数组、数学|:vertical_traffic_light:TODO|
|100197|:point_right:[三步问题](https://leetcode-cn.com/problems/three-steps-problem-lcci)|简单:bulb:|记忆化搜索、数学、动态规划|:vertical_traffic_light:TODO|
|100198|:point_right:[幂集](https://leetcode-cn.com/problems/power-set-lcci)|中等:speech_balloon:|位运算、数组、回溯|:vertical_traffic_light:TODO|
|100199|:point_right:[递归乘法](https://leetcode-cn.com/problems/recursive-mulitply-lcci)|中等:speech_balloon:|位运算、递归、数学|:vertical_traffic_light:TODO|
|100200|:point_right:[括号](https://leetcode-cn.com/problems/bracket-lcci)|中等:speech_balloon:|字符串、动态规划、回溯|:vertical_traffic_light:TODO|
|100201|:point_right:[颜色填充](https://leetcode-cn.com/problems/color-fill-lcci)|简单:bulb:|深度优先搜索、广度优先搜索、数组、矩阵|:vertical_traffic_light:TODO|
|100202|:point_right:[堆箱子](https://leetcode-cn.com/problems/pile-box-lcci)|困难:zzz:|数组、动态规划、排序|:vertical_traffic_light:TODO|
|100203|:point_right:[二进制数转字符串](https://leetcode-cn.com/problems/bianry-number-to-string-lcci)|中等:speech_balloon:|位运算、数学、字符串|:vertical_traffic_light:TODO|
|100228|:point_right:[动物收容所](https://leetcode-cn.com/problems/animal-shelter-lcci)|简单:bulb:|设计、队列|:vertical_traffic_light:TODO|
|100229|:point_right:[检查子树](https://leetcode-cn.com/problems/check-subtree-lcci)|中等:speech_balloon:|树、深度优先搜索、二叉树、字符串匹配、哈希函数|:vertical_traffic_light:TODO|
|100230|:point_right:[翻转数位](https://leetcode-cn.com/problems/reverse-bits-lcci)|简单:bulb:|位运算、动态规划|:vertical_traffic_light:TODO|
|100231|:point_right:[硬币](https://leetcode-cn.com/problems/coin-lcci)|中等:speech_balloon:|数组、数学、动态规划|:vertical_traffic_light:TODO|
|100232|:point_right:[搜索旋转数组](https://leetcode-cn.com/problems/search-rotate-array-lcci)|中等:speech_balloon:|数组、二分查找|:vertical_traffic_light:TODO|
|100233|:point_right:[八皇后](https://leetcode-cn.com/problems/eight-queens-lcci)|困难:zzz:|数组、回溯|:vertical_traffic_light:TODO|
|100240|:point_right:[魔术索引](https://leetcode-cn.com/problems/magic-index-lcci)|简单:bulb:|数组、二分查找|:vertical_traffic_light:TODO|
|100241|:point_right:[无重复字符串的排列组合](https://leetcode-cn.com/problems/permutation-i-lcci)|中等:speech_balloon:|字符串、回溯|:vertical_traffic_light:TODO|
|100242|:point_right:[稀疏数组搜索](https://leetcode-cn.com/problems/sparse-array-search-lcci)|简单:bulb:|数组、字符串、二分查找|:vertical_traffic_light:TODO|
|100258|:point_right:[交换数字](https://leetcode-cn.com/problems/swap-numbers-lcci)|中等:speech_balloon:|位运算、数学|:vertical_traffic_light:TODO|
|100259|:point_right:[单词频率](https://leetcode-cn.com/problems/words-frequency-lcci)|中等:speech_balloon:|设计、字典树、数组、哈希表、字符串|:vertical_traffic_light:TODO|
...
|100337|:point_right:[队列的最大值](https://leetcode-cn.com/problems/dui-lie-de-zui-da-zhi-lcof)|中等:speech_balloon:|设计、队列、单调队列|:vertical_traffic_light:TODO|
...
|100351|:point_right:[生存人数](https://leetcode-cn.com/problems/living-people-lcci)|中等:speech_balloon:|数组、计数|:vertical_traffic_light:TODO|
|100352|:point_right:[跳水板](https://leetcode-cn.com/problems/diving-board-lcci)|简单:bulb:|数组、数学|:vertical_traffic_light:TODO|
|100353|:point_right:[平分正方形](https://leetcode-cn.com/problems/bisect-squares-lcci)|中等:speech_balloon:|几何、数学|:vertical_traffic_light:TODO|
|100354|:point_right:[最佳直线](https://leetcode-cn.com/problems/best-line-lcci)|中等:speech_balloon:|几何、数组、哈希表、数学|:vertical_traffic_light:TODO|
|100355|:point_right:[珠玑妙算](https://leetcode-cn.com/problems/master-mind-lcci)|简单:bulb:|哈希表、字符串、计数|:vertical_traffic_light:TODO|
|100356|:point_right:[部分排序](https://leetcode-cn.com/problems/sub-sort-lcci)|中等:speech_balloon:|栈、贪心、数组、双指针、排序、单调栈|:vertical_traffic_light:TODO|
|1000003|:point_right:[连续数列](https://leetcode-cn.com/problems/contiguous-sequence-lcci)|简单:bulb:|数组、分治、动态规划|:vertical_traffic_light:TODO|
|1000004|:point_right:[模式匹配](https://leetcode-cn.com/problems/pattern-matching-lcci)|中等:speech_balloon:|数学、字符串、回溯、枚举|:vertical_traffic_light:TODO|
|1000005|:point_right:[水域大小](https://leetcode-cn.com/problems/pond-sizes-lcci)|中等:speech_balloon:|深度优先搜索、广度优先搜索、并查集、数组、矩阵|:vertical_traffic_light:TODO|
|1000006|:point_right:[一次编辑](https://leetcode-cn.com/problems/one-away-lcci)|中等:speech_balloon:|双指针、字符串|:vertical_traffic_light:TODO|
...
|1000015|:point_right:[汉诺塔问题](https://leetcode-cn.com/problems/hanota-lcci)|简单:bulb:|递归、数组|:vertical_traffic_light:TODO|
|1000016|:point_right:[排序矩阵查找](https://leetcode-cn.com/problems/sorted-matrix-search-lcci)|中等:speech_balloon:|数组、二分查找、分治、矩阵|:vertical_traffic_light:TODO|
|1000017|:point_right:[阶乘尾数](https://leetcode-cn.com/problems/factorial-zeros-lcci)|简单:bulb:|数学|:vertical_traffic_light:TODO|
...
|1000025|:point_right:[不用加号的加法](https://leetcode-cn.com/problems/add-without-plus-lcci)|简单:bulb:|位运算、数学|:vertical_traffic_light:TODO|
|1000026|:point_right:[LRU 缓存](https://leetcode-cn.com/problems/lru-cache-lcci)|中等:speech_balloon:|设计、哈希表、链表、双向链表|:vertical_traffic_light:TODO|
|1000027|:point_right:[计算器](https://leetcode-cn.com/problems/calculator-lcci)|中等:speech_balloon:|栈、数学、字符串|:vertical_traffic_light:TODO|
|1000028|:point_right:[连续中值](https://leetcode-cn.com/problems/continuous-median-lcci)|困难:zzz:|设计、双指针、数据流、排序、堆（优先队列）|:vertical_traffic_light:TODO|
|1000029|:point_right:[直方图的水量](https://leetcode-cn.com/problems/volume-of-histogram-lcci)|困难:zzz:|栈、数组、双指针、动态规划、单调栈|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/1000029.volume-of-histogram-lcci.java)|
|1000030|:point_right:[单词转换](https://leetcode-cn.com/problems/word-transformer-lcci)|中等:speech_balloon:|广度优先搜索、哈希表、字符串、回溯|:vertical_traffic_light:TODO|
|1000031|:point_right:[布尔运算](https://leetcode-cn.com/problems/boolean-evaluation-lcci)|中等:speech_balloon:|记忆化搜索、字符串、动态规划|:vertical_traffic_light:TODO|
|1000032|:point_right:[消失的数字](https://leetcode-cn.com/problems/missing-number-lcci)|简单:bulb:|位运算、数组、哈希表、数学、排序|:vertical_traffic_light:TODO|
|1000033|:point_right:[ 字母与数字](https://leetcode-cn.com/problems/find-longest-subarray-lcci)|中等:speech_balloon:|数组、哈希表、前缀和|:vertical_traffic_light:TODO|
|1000034|:point_right:[2出现的次数](https://leetcode-cn.com/problems/number-of-2s-in-range-lcci)|困难:zzz:|递归、数学、动态规划|:vertical_traffic_light:TODO|
|1000035|:point_right:[婴儿名字](https://leetcode-cn.com/problems/baby-names-lcci)|中等:speech_balloon:|深度优先搜索、广度优先搜索、并查集、数组、哈希表、字符串、计数|:vertical_traffic_light:TODO|
|1000036|:point_right:[马戏团人塔](https://leetcode-cn.com/problems/circus-tower-lcci)|中等:speech_balloon:|数组、二分查找、动态规划、排序|:vertical_traffic_light:TODO|
|1000037|:point_right:[第 k 个数](https://leetcode-cn.com/problems/get-kth-magic-number-lcci)|中等:speech_balloon:|哈希表、数学、动态规划、堆（优先队列）|:vertical_traffic_light:TODO|
|1000038|:point_right:[主要元素](https://leetcode-cn.com/problems/find-majority-element-lcci)|简单:bulb:|数组、计数|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/1000038.find-majority-element-lcci.java)|
|1000039|:point_right:[单词距离](https://leetcode-cn.com/problems/find-closest-lcci)|中等:speech_balloon:|数组、字符串|:vertical_traffic_light:TODO|
|1000040|:point_right:[变位词组](https://leetcode-cn.com/problems/group-anagrams-lcci)|中等:speech_balloon:|哈希表、字符串、排序|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/1000040.group-anagrams-lcci.java)|
|1000041|:point_right:[数字流的秩](https://leetcode-cn.com/problems/rank-from-stream-lcci)|中等:speech_balloon:|设计、树状数组、二分查找、数据流|:vertical_traffic_light:TODO|
|1000042|:point_right:[数对和](https://leetcode-cn.com/problems/pairs-with-sum-lcci)|中等:speech_balloon:|数组、哈希表、双指针、计数、排序|:vertical_traffic_light:TODO|
|1000043|:point_right:[最短超串](https://leetcode-cn.com/problems/shortest-supersequence-lcci)|中等:speech_balloon:|数组、哈希表、滑动窗口|:vertical_traffic_light:TODO|
|1000044|:point_right:[消失的两个数字](https://leetcode-cn.com/problems/missing-two-lcci)|困难:zzz:|位运算、数组、哈希表|:vertical_traffic_light:TODO|
|1000045|:point_right:[最大黑方阵](https://leetcode-cn.com/problems/max-black-square-lcci)|中等:speech_balloon:|数组、动态规划、矩阵|:vertical_traffic_light:TODO|
|1000046|:point_right:[最大子矩阵](https://leetcode-cn.com/problems/max-submatrix-lcci)|困难:zzz:|数组、动态规划、矩阵、前缀和|:vertical_traffic_light:TODO|
|1000047|:point_right:[T9键盘](https://leetcode-cn.com/problems/t9-lcci)|中等:speech_balloon:|数组、哈希表、字符串|:vertical_traffic_light:TODO|
|1000048|:point_right:[交换和](https://leetcode-cn.com/problems/sum-swap-lcci)|中等:speech_balloon:|数组、哈希表、二分查找、排序|:vertical_traffic_light:TODO|
|1000049|:point_right:[单词矩阵](https://leetcode-cn.com/problems/word-rectangle-lcci)|困难:zzz:|字典树、数组、字符串、回溯|:vertical_traffic_light:TODO|
|1000050|:point_right:[兰顿蚂蚁](https://leetcode-cn.com/problems/langtons-ant-lcci)|中等:speech_balloon:|数组、哈希表、字符串、矩阵、模拟|:vertical_traffic_light:TODO|
|1000051|:point_right:[稀疏相似度](https://leetcode-cn.com/problems/sparse-similarity-lcci)|困难:zzz:|数组、哈希表、排序|:vertical_traffic_light:TODO|
|1000056|:point_right:[拿硬币](https://leetcode-cn.com/problems/na-ying-bi)|简单:bulb:|数组、数学|:vertical_traffic_light:TODO|
|1000057|:point_right:[剧情触发时间](https://leetcode-cn.com/problems/ju-qing-hong-fa-shi-jian)|中等:speech_balloon:|数组、二分查找、排序|:vertical_traffic_light:TODO|
|1000058|:point_right:[魔术排列](https://leetcode-cn.com/problems/er94lq)|中等:speech_balloon:|队列、数组、模拟|:vertical_traffic_light:TODO|
|1000059|:point_right:[切分数组](https://leetcode-cn.com/problems/qie-fen-shu-zu)|困难:zzz:|数组、数学、动态规划、数论|:vertical_traffic_light:TODO|
|1000062|:point_right:[二叉树任务调度](https://leetcode-cn.com/problems/er-cha-shu-ren-wu-diao-du)|困难:zzz:|树、深度优先搜索、动态规划、二叉树|:vertical_traffic_light:TODO|
|1000063|:point_right:[传递信息](https://leetcode-cn.com/problems/chuan-di-xin-xi)|简单:bulb:|深度优先搜索、广度优先搜索、图、动态规划|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/1000063.chuan-di-xin-xi.java)|
|1000085|:point_right:[游乐园的游览计划](https://leetcode-cn.com/problems/you-le-yuan-de-you-lan-ji-hua)|困难:zzz:|图、几何、数学|:vertical_traffic_light:TODO|
|1000086|:point_right:[期望个数统计](https://leetcode-cn.com/problems/qi-wang-ge-shu-tong-ji)|简单:bulb:|数组、哈希表、数学、概率与统计|:vertical_traffic_light:TODO|
|1000087|:point_right:[小张刷题计划](https://leetcode-cn.com/problems/xiao-zhang-shua-ti-ji-hua)|中等:speech_balloon:|数组、二分查找|:vertical_traffic_light:TODO|
|1000088|:point_right:[游乐园的迷宫](https://leetcode-cn.com/problems/you-le-yuan-de-mi-gong)|困难:zzz:|贪心、几何、数组、数学|:vertical_traffic_light:TODO|
|1000089|:point_right:[二叉树染色](https://leetcode-cn.com/problems/er-cha-shu-ran-se-UGC)|中等:speech_balloon:|树、动态规划、二叉树|:vertical_traffic_light:TODO|
|1000090|:point_right:[最小跳跃次数](https://leetcode-cn.com/problems/zui-xiao-tiao-yue-ci-shu)|困难:zzz:|广度优先搜索、线段树、数组、动态规划|:vertical_traffic_light:TODO|
|1000091|:point_right:[最小矩形面积](https://leetcode-cn.com/problems/zui-xiao-ju-xing-mian-ji)|困难:zzz:|贪心、几何、数组、数学、组合数学、排序|:vertical_traffic_light:TODO|
|1000093|:point_right:[寻宝](https://leetcode-cn.com/problems/xun-bao)|困难:zzz:|位运算、广度优先搜索、数组、动态规划、状态压缩、矩阵|:vertical_traffic_light:TODO|
|1000130|:point_right:[秋叶收藏集](https://leetcode-cn.com/problems/UlBDOe)|中等:speech_balloon:|字符串、动态规划|:vertical_traffic_light:TODO|
|1000131|:point_right:[数字游戏](https://leetcode-cn.com/problems/5TxKeK)|困难:zzz:|数组、数学、堆（优先队列）|:vertical_traffic_light:TODO|
|1000132|:point_right:[导航装置](https://leetcode-cn.com/problems/hSRGyL)|困难:zzz:|树、动态规划、二叉树|:vertical_traffic_light:TODO|
|1000133|:point_right:[快速公交](https://leetcode-cn.com/problems/meChtZ)|困难:zzz:|记忆化搜索、数组、动态规划|:vertical_traffic_light:TODO|
|1000134|:point_right:[追逐游戏](https://leetcode-cn.com/problems/Za25hA)|困难:zzz:|深度优先搜索、广度优先搜索、图、拓扑排序|:vertical_traffic_light:TODO|
|1000138|:point_right:[古董键盘](https://leetcode-cn.com/problems/Uh984O)|困难:zzz:|数学、动态规划、组合数学|:vertical_traffic_light:TODO|
|1000139|:point_right:[速算机器人](https://leetcode-cn.com/problems/nGK0Fy)|简单:bulb:|数学、字符串、模拟|:vertical_traffic_light:TODO|
|1000140|:point_right:[黑白方格画](https://leetcode-cn.com/problems/ccw6C7)|简单:bulb:|数学|:vertical_traffic_light:TODO|
|1000146|:point_right:[早餐组合](https://leetcode-cn.com/problems/2vYnGI)|简单:bulb:|数组、双指针、二分查找、排序|:vertical_traffic_light:TODO|
|1000147|:point_right:[黑盒光线反射](https://leetcode-cn.com/problems/IQvJ9i)|困难:zzz:|设计、线段树、数学、有序集合|:vertical_traffic_light:TODO|
|1000215|:point_right:[采购方案](https://leetcode-cn.com/problems/4xy4Wx)|简单:bulb:|数组、双指针、二分查找、排序|:vertical_traffic_light:TODO|
|1000216|:point_right:[乐团站位](https://leetcode-cn.com/problems/SNJvJP)|简单:bulb:|数学|:vertical_traffic_light:TODO|
|1000218|:point_right:[变换的迷宫](https://leetcode-cn.com/problems/Db3wC1)|困难:zzz:|深度优先搜索、广度优先搜索、数组、动态规划、矩阵|:vertical_traffic_light:TODO|
|1000219|:point_right:[批量处理任务](https://leetcode-cn.com/problems/t3fKg1)|困难:zzz:|贪心、数组、堆（优先队列）|:vertical_traffic_light:TODO|
|1000220|:point_right:[电动车游城市](https://leetcode-cn.com/problems/DFPeFJ)|困难:zzz:|图、最短路、堆（优先队列）|:vertical_traffic_light:TODO|
|1000221|:point_right:[蓄水](https://leetcode-cn.com/problems/o8SXZn)|简单:bulb:|贪心、数组、堆（优先队列）|:light_rail:[Java](https://github.com/xsw001/LeedCode-One-Question-Per-Day/tree/main/submitted_code/1000221.o8SXZn.java)|
